...
public final class SharedFlowSlot extends AbstractSharedFlowSlot<SharedFlowImpl<?>> {
    ...
    public Continuation<Unit>[] freeLocked(SharedFlowImpl<?> flow) {
        ...
        this.index = -1L;
        this.cont = null;
        return flow.updateCollectorIndexLocked$kotlinx_coroutines_core(j5);
    }
}
