...
public final class CallbackFlowBuilder<T> extends ChannelFlowBuilder<T> {
    ...
    public /* synthetic */ CallbackFlowBuilder(Function2 function2, CoroutineContext coroutineContext, int i5, BufferOverflow bufferOverflow, int i6, DefaultConstructorMarker defaultConstructorMarker) {
        this(function2, (i6 & 2) != 0 ? EmptyCoroutineContext.INSTANCE : coroutineContext, (i6 & 4) != 0 ? -2 : i5, (i6 & 8) != 0 ? BufferOverflow.SUSPEND : bufferOverflow);
    }
    ...
    */
    public Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof CallbackFlowBuilder$collectTo$1) {
            ...
            int i6 = callbackFlowBuilder$collectTo$1.label;
            if ((i6 & Integer.MIN_VALUE) != 0) {
                callbackFlowBuilder$collectTo$1.label = i6 - Integer.MIN_VALUE;
                Object obj = callbackFlowBuilder$collectTo$1.result;
                Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                i5 = callbackFlowBuilder$collectTo$1.label;
                if (i5 != 0) {
    ...
    public CallbackFlowBuilder(Function2<? super ProducerScope<? super T>, ? super Continuation<? super Unit>, ? extends Object> function2, CoroutineContext coroutineContext, int i5, BufferOverflow bufferOverflow) {
        super(function2, coroutineContext, i5, bufferOverflow);
