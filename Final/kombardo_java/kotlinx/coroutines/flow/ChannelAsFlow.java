...
public final class ChannelAsFlow<T> extends ChannelFlow<T> {
    ...
    public /* synthetic */ ChannelAsFlow(ReceiveChannel receiveChannel, boolean z5, CoroutineContext coroutineContext, int i5, BufferOverflow bufferOverflow, int i6, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public ChannelAsFlow(ReceiveChannel<? extends T> receiveChannel, boolean z5, CoroutineContext coroutineContext, int i5, BufferOverflow bufferOverflow) {
