...
public abstract class ChannelFlowBuilder<T> extends ChannelFlow<T> {
    ...
    public ChannelFlowBuilder(Function2<? super ProducerScope<? super T>, ? super Continuation<? super Unit>, ? extends Object> function2, CoroutineContext coroutineContext, int i5, BufferOverflow bufferOverflow) {
