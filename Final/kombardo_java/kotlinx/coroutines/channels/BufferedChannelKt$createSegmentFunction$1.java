...
public /* synthetic */ class BufferedChannelKt$createSegmentFunction$1<E> extends FunctionReferenceImpl implements Function2<Long, ChannelSegment<E>, ChannelSegment<E>> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Long l5, Object obj) {
        return invoke(l5.longValue(), (ChannelSegment) obj);
    }

    public final ChannelSegment<E> invoke(long j5, ChannelSegment<E> channelSegment) {
        ChannelSegment<E> createSegment;
        createSegment = BufferedChannelKt.createSegment(j5, channelSegment);
