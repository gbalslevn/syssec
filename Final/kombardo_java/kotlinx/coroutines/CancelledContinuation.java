...
public final class CancelledContinuation extends CompletedExceptionally {
    ...
    */
    public CancelledContinuation(Continuation<?> continuation, Throwable th, boolean z5) {
        super(th, z5);
        if (th == null) {
