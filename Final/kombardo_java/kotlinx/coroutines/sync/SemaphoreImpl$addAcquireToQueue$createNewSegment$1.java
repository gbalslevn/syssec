...
/* synthetic */ class SemaphoreImpl$addAcquireToQueue$createNewSegment$1 extends FunctionReferenceImpl implements Function2<Long, SemaphoreSegment, SemaphoreSegment> {
    ...
    public /* bridge */ /* synthetic */ SemaphoreSegment invoke(Long l5, SemaphoreSegment semaphoreSegment) {
        return invoke(l5.longValue(), semaphoreSegment);
    }

    public final SemaphoreSegment invoke(long j5, SemaphoreSegment semaphoreSegment) {
        SemaphoreSegment createSegment;
        createSegment = SemaphoreKt.createSegment(j5, semaphoreSegment);
