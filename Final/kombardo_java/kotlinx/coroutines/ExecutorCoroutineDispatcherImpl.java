...
public final class ExecutorCoroutineDispatcherImpl extends ExecutorCoroutineDispatcher implements Delay {
    ...
    private final ScheduledFuture<?> scheduleBlock(ScheduledExecutorService scheduledExecutorService, Runnable runnable, CoroutineContext coroutineContext, long j5) {
        try {
            return scheduledExecutorService.schedule(runnable, j5, TimeUnit.MILLISECONDS);
        } catch (RejectedExecutionException e5) {
            cancelJobOnRejection(coroutineContext, e5);
            return null;
        }
    }
    ...
    public void dispatch(CoroutineContext context, Runnable block) {
        try {
            ...
            AbstractTimeSourceKt.getTimeSource();
            cancelJobOnRejection(context, e5);
