...
public abstract class KeyValueSerializer<K, V, R> implements KSerializer<R> {
    ...
    public R deserialize(Decoder decoder) {
        ...
        if (beginStructure.decodeSequentially()) {
            r5 = (R) toResult(CompositeDecoder.DefaultImpls.decodeSerializableElement$default(beginStructure, getDescriptor(), 0, getKeySerializer(), null, 8, null), CompositeDecoder.DefaultImpls.decodeSerializableElement$default(beginStructure, getDescriptor(), 1, getValueSerializer(), null, 8, null));
        } else {
            obj = TuplesKt.NULL;
            obj2 = TuplesKt.NULL;
            Object obj5 = obj;
    ...
    protected abstract K getKey(R r5);

    protected final KSerializer<K> getKeySerializer() {
        return this.keySerializer;
    }

    protected abstract V getValue(R r5);
