...
public final class ReferenceArraySerializer<ElementKlass, Element extends ElementKlass> extends CollectionLikeSerializer<Element, Element[], ArrayList<Element>> {
    ...
    public /* bridge */ /* synthetic */ void insert(Object obj, int i5, Object obj2) {
        insert((ArrayList<int>) obj, i5, (int) obj2);
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // kotlinx.serialization.internal.AbstractCollectionSerializer
    public void checkCapacity(ArrayList<Element> arrayList, int i5) {
        Intrinsics.checkNotNullParameter(arrayList, "<this>");
    ...
    protected void insert(ArrayList<Element> arrayList, int i5, Element element) {
        Intrinsics.checkNotNullParameter(arrayList, "<this>");
