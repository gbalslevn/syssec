...
public final class ArrayListSerializer<E> extends CollectionSerializer<E, List<? extends E>, ArrayList<E>> {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // kotlinx.serialization.internal.AbstractCollectionSerializer
    public void checkCapacity(ArrayList<E> arrayList, int i5) {
        Intrinsics.checkNotNullParameter(arrayList, "<this>");
        arrayList.ensureCapacity(i5);
    }

    protected void insert(ArrayList<E> arrayList, int i5, E e5) {
        Intrinsics.checkNotNullParameter(arrayList, "<this>");
        arrayList.add(i5, e5);
    }
