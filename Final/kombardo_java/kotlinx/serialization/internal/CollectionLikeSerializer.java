...
public abstract class CollectionLikeSerializer<Element, Collection, Builder> extends AbstractCollectionSerializer<Element, Collection, Builder> {
    ...
    protected abstract void insert(Builder builder, int i5, Element element);
    ...
    protected final void readAll(CompositeDecoder decoder, Builder builder, int startIndex, int size) {
        ...
        for (int i5 = 0; i5 < size; i5++) {
            readElement(decoder, startIndex + i5, builder, false);
        }
    }
