...
public abstract class Utils {
    ...
    public static RuntimeException parameterError(Method method, Throwable th, int i5, String str, Object... objArr) {
        return methodError(method, th, str + " (" + Platform.reflection.describeMethodParameter(method, i5) + ")", objArr);
    }
    ...
    static Type resolve(Type type, Class<?> cls, Type type2) {
        ...
        if (type3 instanceof ParameterizedType) {
            ...
            boolean z5 = resolve3 != ownerType;
            Type[] actualTypeArguments = parameterizedType.getActualTypeArguments();
            int length = actualTypeArguments.length;
            for (int i5 = 0; i5 < length; i5++) {
                Type resolve4 = resolve(type, cls, actualTypeArguments[i5]);
                if (resolve4 != actualTypeArguments[i5]) {
                    if (!z5) {
                        actualTypeArguments = (Type[]) actualTypeArguments.clone();
                        z5 = true;
                    }
                    actualTypeArguments[i5] = resolve4;
                }
            }
            return z5 ? new ParameterizedTypeImpl(resolve3, parameterizedType.getRawType(), actualTypeArguments) : parameterizedType;
        }
    ...
    public static RuntimeException parameterError(Method method, int i5, String str, Object... objArr) {
        return methodError(method, str + " (" + Platform.reflection.describeMethodParameter(method, i5) + ")", objArr);
    }
}
