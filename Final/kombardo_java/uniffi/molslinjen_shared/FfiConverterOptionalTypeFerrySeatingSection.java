...
@Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\bÆ\u0002\u0018\u00002\n\u0012\u0006\u0012\u0004\u0018\u00010\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0003J\"\u0010\u0004\u001a\u00020\u00052\b\u0010\u0006\u001a\u0004\u0018\u00010\u0002H\u0016ø\u0001\u0000ø\u0001\u0001ø\u0001\u0002¢\u0006\u0004\b\u0007\u0010\bJ\u0012\u0010\t\u001a\u0004\u0018\u00010\u00022\u0006\u0010\n\u001a\u00020\u000bH\u0016J\u001a\u0010\f\u001a\u00020\r2\b\u0010\u0006\u001a\u0004\u0018\u00010\u00022\u0006\u0010\n\u001a\u00020\u000bH\u0016\u0082\u0002\u000f\n\u0002\b!\n\u0005\b¡\u001e0\u0001\n\u0002\b\u0019¨\u0006\u000e"}, d2 = {"Luniffi/molslinjen_shared/FfiConverterOptionalTypeFerrySeatingSection;", "Luniffi/molslinjen_shared/FfiConverterRustBuffer;", "Luniffi/molslinjen_shared/FerrySeatingSection;", "()V", "allocationSize", "Lkotlin/ULong;", "value", "allocationSize-I7RO_PI", "(Luniffi/molslinjen_shared/FerrySeatingSection;)J", "read", "buf", "Ljava/nio/ByteBuffer;", "write", BuildConfig.FLAVOR, "shared_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class FfiConverterOptionalTypeFerrySeatingSection implements FfiConverterRustBuffer<FerrySeatingSection> {
    public static final FfiConverterOptionalTypeFerrySeatingSection INSTANCE = new FfiConverterOptionalTypeFerrySeatingSection();

    private FfiConverterOptionalTypeFerrySeatingSection() {
    }
    ...
    public long mo3834allocationSizeI7RO_PI(FerrySeatingSection value) {
        ...
        return ULong.m3622constructorimpl(FfiConverterTypeFerrySeatingSection.INSTANCE.mo3834allocationSizeI7RO_PI(value) + 1);
    }
    ...
    public FerrySeatingSection read(ByteBuffer buf) {
        ...
        return FfiConverterTypeFerrySeatingSection.INSTANCE.read(buf);
    }
    ...
    public void write(FerrySeatingSection value, ByteBuffer buf) {
        ...
        if (value == null) {
            ...
            buf.put((byte) 1);
            FfiConverterTypeFerrySeatingSection.INSTANCE.write(value, buf);
        }
    }
