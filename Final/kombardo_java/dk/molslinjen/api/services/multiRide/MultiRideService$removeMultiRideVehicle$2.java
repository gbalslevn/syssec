...
@DebugMetadata(c = "dk.molslinjen.api.services.multiRide.MultiRideService$removeMultiRideVehicle$2", f = "MultiRideService.kt", l = {145}, m = "invokeSuspend")
/* loaded from: classes2.dex */
final class MultiRideService$removeMultiRideVehicle$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<? extends Unit>>, Object> {
    ...
    public MultiRideService$removeMultiRideVehicle$2(MultiRideService multiRideService, String str, String str2, SiteDTO siteDTO, Continuation<? super MultiRideService$removeMultiRideVehicle$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new MultiRideService$removeMultiRideVehicle$2(this.this$0, this.$multiRideId, this.$licensePlate, this.$site, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            this.label = 1;
            obj = multiRideApi.removeMultiRideVehicle(str, str2, siteDTO, this);
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super ApiResult<Unit>> continuation) {
        return ((MultiRideService$removeMultiRideVehicle$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
