...
@DebugMetadata(c = "dk.molslinjen.api.services.multiRide.MultiRideService$getReceipt$2", f = "MultiRideService.kt", l = {121}, m = "invokeSuspend")
/* loaded from: classes2.dex */
final class MultiRideService$getReceipt$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<? extends MultiRideSummaryResponseDTO>>, Object> {
    final /* synthetic */ PhoneNumberDTO $phone;
    ...
    public MultiRideService$getReceipt$2(MultiRideService multiRideService, String str, PhoneNumberDTO phoneNumberDTO, SiteDTO siteDTO, Continuation<? super MultiRideService$getReceipt$2> continuation) {
        super(2, continuation);
        this.this$0 = multiRideService;
        this.$reservationNumber = str;
        this.$phone = phoneNumberDTO;
        this.$site = siteDTO;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new MultiRideService$getReceipt$2(this.this$0, this.$reservationNumber, this.$phone, this.$site, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            String phoneNumberDTO = this.$phone.toString();
            SiteDTO siteDTO = this.$site;
            this.label = 1;
            obj = multiRideApi.getMultiRideReceipt(str, phoneNumberDTO, siteDTO, this);
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super ApiResult<MultiRideSummaryResponseDTO>> continuation) {
        return ((MultiRideService$getReceipt$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
