...
@DebugMetadata(c = "dk.molslinjen.api.services.saleOnBoard.SaleOnBoardService$cancelOrder$2", f = "SaleOnBoardService.kt", l = {Function.THROW_LAST_ERROR}, m = "invokeSuspend")
/* loaded from: classes2.dex */
final class SaleOnBoardService$cancelOrder$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<? extends Unit>>, Object> {
    ...
    public SaleOnBoardService$cancelOrder$2(SaleOnBoardService saleOnBoardService, String str, Continuation<? super SaleOnBoardService$cancelOrder$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new SaleOnBoardService$cancelOrder$2(this.this$0, this.$orderNumber, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            this.label = 1;
            obj = saleOnBoardApi.cancelOrder(str, this);
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super ApiResult<Unit>> continuation) {
        return ((SaleOnBoardService$cancelOrder$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
