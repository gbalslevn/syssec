...
@DebugMetadata(c = "dk.molslinjen.api.services.account.vehicle.AccountVehicleService$deleteVehicle$2", f = "AccountVehicleService.kt", l = {48}, m = "invokeSuspend")
/* loaded from: classes2.dex */
final class AccountVehicleService$deleteVehicle$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<? extends Unit>>, Object> {
    ...
    public AccountVehicleService$deleteVehicle$2(AccountVehicleService accountVehicleService, String str, AuthTokenDTO authTokenDTO, Continuation<? super AccountVehicleService$deleteVehicle$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AccountVehicleService$deleteVehicle$2(this.this$0, this.$vehicleId, this.$authToken, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            this.label = 1;
            obj = AccountVehiclesApi.DefaultImpls.deleteVehicle$default(accountVehiclesApi, str, null, token, this, 2, null);
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super ApiResult<Unit>> continuation) {
        return ((AccountVehicleService$deleteVehicle$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
