...
@DebugMetadata(c = "dk.molslinjen.api.services.account.vehicle.AccountVehicleService$registerVehicle$2", f = "AccountVehicleService.kt", l = {35}, m = "invokeSuspend")
/* loaded from: classes2.dex */
final class AccountVehicleService$registerVehicle$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<? extends VehicleDTO>>, Object> {
    ...
    public AccountVehicleService$registerVehicle$2(String str, String str2, AccountVehicleService accountVehicleService, AuthTokenDTO authTokenDTO, Continuation<? super AccountVehicleService$registerVehicle$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AccountVehicleService$registerVehicle$2(this.$name, this.$licensePlate, this.this$0, this.$authToken, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            RegisterVehicleRequestParameter registerVehicleRequestParameter = new RegisterVehicleRequestParameter(this.$name, this.$licensePlate);
            accountVehiclesApi = this.this$0.api;
            String token = this.$authToken.getToken();
            this.label = 1;
            obj = AccountVehiclesApi.DefaultImpls.registerVehicle$default(accountVehiclesApi, registerVehicleRequestParameter, null, token, this, 2, null);
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super ApiResult<VehicleDTO>> continuation) {
        return ((AccountVehicleService$registerVehicle$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
