...
@DebugMetadata(c = "dk.molslinjen.api.services.account.passenger.AccountPassengerService$updatePassenger$2", f = "AccountPassengerService.kt", l = {42}, m = "invokeSuspend")
/* loaded from: classes2.dex */
final class AccountPassengerService$updatePassenger$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<? extends AccountPassengerDTO>>, Object> {
    final /* synthetic */ AuthTokenDTO $authToken;
    final /* synthetic */ UpdatePassengerRequestParameter $requestParameters;
    int label;
    final /* synthetic */ AccountPassengerService this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AccountPassengerService$updatePassenger$2(AccountPassengerService accountPassengerService, UpdatePassengerRequestParameter updatePassengerRequestParameter, AuthTokenDTO authTokenDTO, Continuation<? super AccountPassengerService$updatePassenger$2> continuation) {
        super(2, continuation);
        this.this$0 = accountPassengerService;
        this.$requestParameters = updatePassengerRequestParameter;
        this.$authToken = authTokenDTO;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AccountPassengerService$updatePassenger$2(this.this$0, this.$requestParameters, this.$authToken, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            UpdatePassengerRequestParameter updatePassengerRequestParameter = this.$requestParameters;
            String token = this.$authToken.getToken();
            this.label = 1;
            obj = AccountPassengersApi.DefaultImpls.updatePassenger$default(accountPassengersApi, updatePassengerRequestParameter, null, token, this, 2, null);
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super ApiResult<AccountPassengerDTO>> continuation) {
        return ((AccountPassengerService$updatePassenger$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
