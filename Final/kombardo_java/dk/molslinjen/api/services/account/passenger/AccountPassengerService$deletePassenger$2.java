...
@DebugMetadata(c = "dk.molslinjen.api.services.account.passenger.AccountPassengerService$deletePassenger$2", f = "AccountPassengerService.kt", l = {51}, m = "invokeSuspend")
/* loaded from: classes2.dex */
final class AccountPassengerService$deletePassenger$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<? extends Unit>>, Object> {
    ...
    public AccountPassengerService$deletePassenger$2(AccountPassengerService accountPassengerService, String str, AuthTokenDTO authTokenDTO, Continuation<? super AccountPassengerService$deletePassenger$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AccountPassengerService$deletePassenger$2(this.this$0, this.$passengerId, this.$authToken, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            this.label = 1;
            obj = AccountPassengersApi.DefaultImpls.deletePassenger$default(accountPassengersApi, str, null, token, this, 2, null);
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super ApiResult<Unit>> continuation) {
        return ((AccountPassengerService$deletePassenger$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
