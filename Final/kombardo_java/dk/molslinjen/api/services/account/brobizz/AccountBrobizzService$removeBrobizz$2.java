...
@DebugMetadata(c = "dk.molslinjen.api.services.account.brobizz.AccountBrobizzService$removeBrobizz$2", f = "AccountBrobizzService.kt", l = {34}, m = "invokeSuspend")
/* loaded from: classes2.dex */
final class AccountBrobizzService$removeBrobizz$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<? extends Unit>>, Object> {
    ...
    public AccountBrobizzService$removeBrobizz$2(AccountBrobizzService accountBrobizzService, String str, AuthTokenDTO authTokenDTO, Continuation<? super AccountBrobizzService$removeBrobizz$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AccountBrobizzService$removeBrobizz$2(this.this$0, this.$brobizzId, this.$authToken, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            this.label = 1;
            obj = AccountBrobizzApi.DefaultImpls.deleteBrobizz$default(accountBrobizzApi, str, null, token, this, 2, null);
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super ApiResult<Unit>> continuation) {
        return ((AccountBrobizzService$removeBrobizz$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
