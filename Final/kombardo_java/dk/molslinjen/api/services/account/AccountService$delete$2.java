...
@DebugMetadata(c = "dk.molslinjen.api.services.account.AccountService$delete$2", f = "AccountService.kt", l = {129}, m = "invokeSuspend")
/* loaded from: classes2.dex */
final class AccountService$delete$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<? extends Unit>>, Object> {
    ...
    public AccountService$delete$2(AccountService accountService, SiteDTO siteDTO, AuthTokenDTO authTokenDTO, Continuation<? super AccountService$delete$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AccountService$delete$2(this.this$0, this.$site, this.$authToken, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            this.label = 1;
            obj = accountApi.delete(siteDTO, token, this);
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super ApiResult<Unit>> continuation) {
        return ((AccountService$delete$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
