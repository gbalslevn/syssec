...
@DebugMetadata(c = "dk.molslinjen.api.services.account.booking.AccountBookingsService$addExistingBooking$2", f = "AccountBookingsService.kt", l = {57}, m = "invokeSuspend")
/* loaded from: classes2.dex */
final class AccountBookingsService$addExistingBooking$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<? extends Unit>>, Object> {
    ...
    public AccountBookingsService$addExistingBooking$2(String str, String str2, AccountBookingsService accountBookingsService, AuthTokenDTO authTokenDTO, Continuation<? super AccountBookingsService$addExistingBooking$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AccountBookingsService$addExistingBooking$2(this.$reservationNumber, this.$phoneNumber, this.this$0, this.$authToken, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            AddExistingBookingRequestParameters addExistingBookingRequestParameters = new AddExistingBookingRequestParameters(this.$reservationNumber, this.$phoneNumber);
            accountBookingsApi = this.this$0.api;
            String token = this.$authToken.getToken();
            this.label = 1;
            obj = AccountBookingsApi.DefaultImpls.addExistingBooking$default(accountBookingsApi, addExistingBookingRequestParameters, null, token, this, 2, null);
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super ApiResult<Unit>> continuation) {
        return ((AccountBookingsService$addExistingBooking$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
