...
@DebugMetadata(c = "dk.molslinjen.api.services.account.AccountService$changeAccountContext$2", f = "AccountService.kt", l = {41}, m = "invokeSuspend")
/* loaded from: classes2.dex */
final class AccountService$changeAccountContext$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<? extends AuthTokenDTO>>, Object> {
    ...
    public AccountService$changeAccountContext$2(AccountService accountService, String str, SiteDTO siteDTO, AuthTokenDTO authTokenDTO, Continuation<? super AccountService$changeAccountContext$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AccountService$changeAccountContext$2(this.this$0, this.$companyId, this.$site, this.$authToken, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            ChangeAccountRequestParameters changeAccountRequestParameters = new ChangeAccountRequestParameters(this.$companyId);
            SiteDTO siteDTO = this.$site;
            String token = this.$authToken.getToken();
            this.label = 1;
            obj = accountApi.changeAccountContext(changeAccountRequestParameters, siteDTO, token, this);
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super ApiResult<AuthTokenDTO>> continuation) {
        return ((AccountService$changeAccountContext$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
