...
@DebugMetadata(c = "dk.molslinjen.api.services.account.AccountService$activate$2", f = "AccountService.kt", l = {77}, m = "invokeSuspend")
/* loaded from: classes2.dex */
final class AccountService$activate$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<? extends AuthTokenDTO>>, Object> {
    final /* synthetic */ String $activationToken;
    ...
    public AccountService$activate$2(AccountService accountService, String str, SiteDTO siteDTO, Continuation<? super AccountService$activate$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AccountService$activate$2(this.this$0, this.$activationToken, this.$site, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            ActivateAccountRequestParameters activateAccountRequestParameters = new ActivateAccountRequestParameters(this.$activationToken);
            SiteDTO siteDTO = this.$site;
            this.label = 1;
            obj = accountApi.activate(activateAccountRequestParameters, siteDTO, this);
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super ApiResult<AuthTokenDTO>> continuation) {
        return ((AccountService$activate$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
