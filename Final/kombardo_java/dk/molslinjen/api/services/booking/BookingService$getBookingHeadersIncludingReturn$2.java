...
@DebugMetadata(c = "dk.molslinjen.api.services.booking.BookingService$getBookingHeadersIncludingReturn$2", f = "BookingService.kt", l = {125}, m = "invokeSuspend")
/* loaded from: classes2.dex */
final class BookingService$getBookingHeadersIncludingReturn$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<? extends BookingHeadersResponseDTO>>, Object> {
    ...
    public BookingService$getBookingHeadersIncludingReturn$2(BookingService bookingService, String str, String str2, Continuation<? super BookingService$getBookingHeadersIncludingReturn$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new BookingService$getBookingHeadersIncludingReturn$2(this.this$0, this.$reservationNumber, this.$phone, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            this.label = 1;
            obj = BookingApi.DefaultImpls.getBookingHeadersIncludingReturn$default(bookingApi, str, str2, false, null, this, 12, null);
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super ApiResult<BookingHeadersResponseDTO>> continuation) {
        return ((BookingService$getBookingHeadersIncludingReturn$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
