...
@DebugMetadata(c = "dk.molslinjen.api.services.booking.BookingService$getBookingHeaders$2", f = "BookingService.kt", l = {137}, m = "invokeSuspend")
/* loaded from: classes2.dex */
final class BookingService$getBookingHeaders$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ApiResult<? extends BookingHeadersResponseDTO>>, Object> {
    ...
    public BookingService$getBookingHeaders$2(BookingService bookingService, BookingsRequestParameters bookingsRequestParameters, Continuation<? super BookingService$getBookingHeaders$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new BookingService$getBookingHeaders$2(this.this$0, this.$requestParameters, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            this.label = 1;
            obj = BookingApi.DefaultImpls.getBookingHeaders$default(bookingApi, bookingsRequestParameters, null, this, 2, null);
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super ApiResult<BookingHeadersResponseDTO>> continuation) {
        return ((BookingService$getBookingHeaders$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
