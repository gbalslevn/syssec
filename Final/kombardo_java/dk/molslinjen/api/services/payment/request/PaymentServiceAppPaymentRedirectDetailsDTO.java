...
import dk.molslinjen.api.services.booking.response.booking.BaseAppPaymentRedirectDetailsDTO;
...
public final class PaymentServiceAppPaymentRedirectDetailsDTO implements BaseAppPaymentRedirectDetailsDTO {
    ...
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005¨\u0006\u0007"}, d2 = {"Ldk/molslinjen/api/services/payment/request/PaymentServiceAppPaymentRedirectDetailsDTO$Companion;", BuildConfig.FLAVOR, "<init>", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Ldk/molslinjen/api/services/payment/request/PaymentServiceAppPaymentRedirectDetailsDTO;", "api_kombardoProd"}, k = 1, mv = {2, 1, 0}, xi = 48)
    /* loaded from: classes2.dex */
    public static final class Companion {
        private Companion() {
        }

        public final KSerializer<PaymentServiceAppPaymentRedirectDetailsDTO> serializer() {
            return PaymentServiceAppPaymentRedirectDetailsDTO$$serializer.INSTANCE;
        }
    ...
    public /* synthetic */ PaymentServiceAppPaymentRedirectDetailsDTO(int i5, String str, String str2, String str3, String str4, String str5, String str6, Boolean bool, Boolean bool2, Integer num, Float f5, Float f6, Integer num2, SerializationConstructorMarker serializationConstructorMarker) {
        if (4095 != (i5 & 4095)) {
            PluginExceptionsKt.throwMissingFieldException(i5, 4095, PaymentServiceAppPaymentRedirectDetailsDTO$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public static final /* synthetic */ void write$Self$api_kombardoProd(PaymentServiceAppPaymentRedirectDetailsDTO self, CompositeEncoder output, SerialDescriptor serialDesc) {
    ...
    public PaymentServiceAppPaymentRedirectDetailsDTO(String str, String str2, String str3, String str4, String str5, String str6, Boolean bool, Boolean bool2, Integer num, Float f5, Float f6, Integer num2) {
        this.cardHolderName = str;
        this.accept = str2;
        this.acceptLanguage = str3;
        this.userAgent = str4;
    ...
    */
    public PaymentServiceAppPaymentRedirectDetailsDTO(float f5, float f6, String language, String str) {
