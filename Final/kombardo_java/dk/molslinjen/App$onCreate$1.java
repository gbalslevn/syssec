...
@DebugMetadata(c = "dk.molslinjen.App$onCreate$1", f = "App.kt", l = {106}, m = "invokeSuspend")
...
final class App$onCreate$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            IMigrator migrator = this.this$0.getMigrator();
            App app = this.this$0;
            this.label = 1;
            if (migrator.migrate(app, this) == coroutine_suspended) {
