...
@Metadata(d1 = {"\u00006\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0003\u0010\u0004J\u0015\u0010\u0005\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00070\u0006¢\u0006\u0002\u0010\bJ\u000e\u0010\t\u001a\u00020\u00022\u0006\u0010\n\u001a\u00020\u000bJ\u0016\u0010\f\u001a\u00020\r2\u0006\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\u0010\u001a\u00020\u0002R\u0011\u0010\u0011\u001a\u00020\u0012¢\u0006\b\n\u0000\u001a\u0004\b\u0013\u0010\u0014¨\u0006\u0015"}, d2 = {"dk/molslinjen/domain/model/info/InfoAlert.$serializer", "Lkotlinx/serialization/internal/GeneratedSerializer;", "Ldk/molslinjen/domain/model/info/InfoAlert;", "<init>", "()V", "childSerializers", BuildConfig.FLAVOR, "Lkotlinx/serialization/KSerializer;", "()[Lkotlinx/serialization/KSerializer;", "deserialize", "decoder", "Lkotlinx/serialization/encoding/Decoder;", "serialize", BuildConfig.FLAVOR, "encoder", "Lkotlinx/serialization/encoding/Encoder;", "value", "descriptor", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "domain_kombardoProd"}, k = 1, mv = {2, 1, 0}, xi = 48)
@Deprecated
/* loaded from: classes2.dex */
public /* synthetic */ class InfoAlert$$serializer implements GeneratedSerializer<InfoAlert> {
    public static final InfoAlert$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    static {
        InfoAlert$$serializer infoAlert$$serializer = new InfoAlert$$serializer();
        INSTANCE = infoAlert$$serializer;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("dk.molslinjen.domain.model.info.InfoAlert", infoAlert$$serializer, 8);
        ...
        pluginGeneratedSerialDescriptor.addElement("shown", true);
        descriptor = pluginGeneratedSerialDescriptor;
    }

    private InfoAlert$$serializer() {
    }

    @Override // kotlinx.serialization.internal.GeneratedSerializer
    public final KSerializer<?>[] childSerializers() {
        KSerializer[] kSerializerArr;
        kSerializerArr = InfoAlert.$childSerializers;
        StringSerializer stringSerializer = StringSerializer.INSTANCE;
        return new KSerializer[]{stringSerializer, stringSerializer, stringSerializer, BuiltinSerializersKt.getNullable(stringSerializer), BuiltinSerializersKt.getNullable(stringSerializer), BuiltinSerializersKt.getNullable(kSerializerArr[5]), BuiltinSerializersKt.getNullable(stringSerializer), BooleanSerializer.INSTANCE};
    }

    /* JADX WARN: Failed to find 'out' block for switch in B:10:0x0073. Please report as an issue. */
    @Override // kotlinx.serialization.DeserializationStrategy
    public final InfoAlert deserialize(Decoder decoder) {
        KSerializer[] kSerializerArr;
        boolean z5;
        String str;
        InfoAlert.IconType iconType;
        String str2;
        String str3;
        int i5;
        String str4;
        ...
        if (beginStructure.decodeSequentially()) {
            ...
            InfoAlert.IconType iconType2 = (InfoAlert.IconType) beginStructure.decodeNullableSerializableElement(serialDescriptor, 5, kSerializerArr[5], null);
            ...
            boolean z7 = false;
            String str10 = null;
            InfoAlert.IconType iconType3 = null;
            String str11 = null;
            String str12 = null;
            String str13 = null;
            String str14 = null;
            ...
            while (z6) {
                ...
                switch (decodeElementIndex) {
                    ...
                    case 4:
                        ...
                        i6 = 7;
                    case 5:
                        iconType3 = (InfoAlert.IconType) beginStructure.decodeNullableSerializableElement(serialDescriptor, 5, kSerializerArr[5], iconType3);
                        i7 |= 32;
                    case 6:
                        str10 = (String) beginStructure.decodeNullableSerializableElement(serialDescriptor, 6, StringSerializer.INSTANCE, str10);
                        i7 |= 64;
                    case 7:
                        z7 = beginStructure.decodeBooleanElement(serialDescriptor, i6);
                        i7 |= 128;
                    default:
        ...
        return new InfoAlert(i5, str4, str5, str6, str3, str2, iconType, str, z5, (SerializationConstructorMarker) null);
    }
    ...
    public final void serialize(Encoder encoder, InfoAlert value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder beginStructure = encoder.beginStructure(serialDescriptor);
        InfoAlert.write$Self$domain_kombardoProd(value, beginStructure, serialDescriptor);
        beginStructure.endStructure(serialDescriptor);
    }
