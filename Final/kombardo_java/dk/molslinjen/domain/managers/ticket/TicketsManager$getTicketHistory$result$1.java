...
@DebugMetadata(c = "dk.molslinjen.domain.managers.ticket.TicketsManager$getTicketHistory$result$1", f = "TicketsManager.kt", l = {271}, m = "invokeSuspend")
/* loaded from: classes2.dex */
public final class TicketsManager$getTicketHistory$result$1 extends SuspendLambda implements Function2<AccountBookingHeadersResponseDTO, Continuation<? super List<? extends BookingHeader>>, Object> {
    ...
    public TicketsManager$getTicketHistory$result$1(TicketsManager ticketsManager, Continuation<? super TicketsManager$getTicketHistory$result$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        TicketsManager$getTicketHistory$result$1 ticketsManager$getTicketHistory$result$1 = new TicketsManager$getTicketHistory$result$1(this.this$0, continuation);
        ticketsManager$getTicketHistory$result$1.L$0 = obj;
        return ticketsManager$getTicketHistory$result$1;
    }
    ...
    public final Object invoke2(AccountBookingHeadersResponseDTO accountBookingHeadersResponseDTO, Continuation<? super List<BookingHeader>> continuation) {
        return ((TicketsManager$getTicketHistory$result$1) create(accountBookingHeadersResponseDTO, continuation)).invokeSuspend(Unit.INSTANCE);
    }
