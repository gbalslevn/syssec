...
public final class UserRepository extends FileObjectRepository<User> implements IUserRepository {
    ...
    public Object save(User user, Continuation<? super Unit> continuation) {
        Object saveItem = super.saveItem(user, continuation);
