...
@DebugMetadata(c = "dk.molslinjen.ui.views.global.navigation.MainActivity$onResume$1", f = "MainActivity.kt", l = {193}, m = "invokeSuspend")
...
final class MainActivity$onResume$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new MainActivity$onResume$1(this.this$0, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            this.this$0.getAppUpdater().checkForUpdates(this.this$0);
            IPushHandler pushHandler = this.this$0.getPushHandler();
            this.label = 1;
        ...
        this.this$0.getAnalyticsTracker().updateStateTracking(this.this$0.getUserManager(), this.this$0.getPushHandlerProvider());
        this.this$0.getAnalyticsTracker().updateActiveTab(DestinationSpecExtensionsKt.toTrackingTab(DeparturesScreenDestination.INSTANCE));
