...
public final class EditFlowStickyTopBarWrapper implements DestinationWrapper {
    ...
    public static final Unit Wrap$lambda$2$lambda$1$lambda$0(DeparturesViewModel departuresViewModel, DestinationScope destinationScope) {
        INSTANCE.abortEditFlow(departuresViewModel, destinationScope.getDestinationsNavigator());
    ...
    */
    public <T> void Wrap(final DestinationScope<T> destinationScope, Function2<? super Composer, ? super Integer, Unit> screenContent, Composer composer, int i5) {
        Object obj;
        ViewModel viewModel;
        EditManager.EditState editState;
        Intrinsics.checkNotNullParameter(destinationScope, "<this>");
        Intrinsics.checkNotNullParameter(screenContent, "screenContent");
        composer.startReplaceGroup(-1595955784);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1595955784, i5, -1, "dk.molslinjen.ui.views.global.navigation.wrappers.EditFlowStickyTopBarWrapper.Wrap (EditFlowStickyTopBarWrapper.kt:16)");
        }
        NavController navController = destinationScope.getNavController();
        DeparturesEditScreenDestination departuresEditScreenDestination = DeparturesEditScreenDestination.INSTANCE;
        ...
        while (true) {
            if (!listIterator.hasPrevious()) {
                ...
                if (Intrinsics.areEqual(((NavBackStackEntry) obj).getDestination().getRoute(), departuresEditScreenDestination.getRoute())) {
                    break;
                }
            }
        }
        ...
        if (navBackStackEntry == null) {
            ...
            composer.startReplaceGroup(1591280949);
            if (r1 != null) {
            }
            composer.endReplaceGroup();
            if (r1 != null) {
            }
            composer.startReplaceGroup(1591282049);
            if (editState != null) {
            }
        ...
        StateFlow<EditManager.EditState> editState2 = departuresViewModel2 == null ? departuresViewModel2.getEditState() : null;
        composer.startReplaceGroup(1591280949);
        State collectAsState = editState2 != null ? null : SnapshotStateKt.collectAsState(editState2, null, composer, 0, 1);
        composer.endReplaceGroup();
        editState = collectAsState != null ? (EditManager.EditState) collectAsState.getValue() : null;
        composer.startReplaceGroup(1591282049);
        if (editState != null || !editState.getIsEditing()) {
            screenContent.invoke(composer, Integer.valueOf((i5 >> 3) & 14));
            composer.endReplaceGroup();
            if (ComposerKt.isTraceInProgress()) {
        ...
        composer.startReplaceGroup(-482668493);
        ...
        if (z6 || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = new Function0() { // from class: U1.c
                ...
                public final Object invoke() {
                    ...
                    Wrap$lambda$2$lambda$1$lambda$0 = EditFlowStickyTopBarWrapper.Wrap$lambda$2$lambda$1$lambda$0(DeparturesViewModel.this, destinationScope);
        ...
        composer.endReplaceGroup();
        CheckoutEditFlowTopBarKt.CheckoutEditFlowTopBar((Function0) rememberedValue, composer, 0);
        screenContent.invoke(composer, Integer.valueOf((i5 >> 3) & 14));
        composer.endNode();
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final void abortEditFlow(DeparturesViewModel viewModel, DestinationsNavigator navigator) {
