...
@DebugMetadata(c = "dk.molslinjen.ui.views.global.navigation.MainActivity$onResume$2", f = "MainActivity.kt", l = {202}, m = "invokeSuspend")
...
final class MainActivity$onResume$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            SettingsProperty.Tracking.AppOpenedCount appOpenedCount = SettingsProperty.Tracking.AppOpenedCount.INSTANCE;
            int intValue = ((Number) settings.latestValueFor(appOpenedCount)).intValue();
            if (intValue == 0) {
                this.this$0.getAdjustTracker().firstOpen();
            }
            ISettings settings2 = this.this$0.getSettings();
            Integer boxInt = Boxing.boxInt(intValue + 1);
            this.label = 1;
            if (settings2.update(appOpenedCount, boxInt, this) == coroutine_suspended) {
