...
public final class EmailInputValidator implements IInputValidator.StringValidator {
    ...
    public InputValidationError validate(String input) {
        ...
        if (StringExtensionsKt.isEmail(input)) {
            return null;
        }
        return new InputValidationError.Predefined(R.string.validation_email);
    }
}
