...
public final class CheckoutPassengerCreateViewModel extends ViewModel implements IPassengerInputHandler {
    ...
    private final CheckoutPassengerCreateScreenNavArgs navArgs;
    ...
    public CheckoutPassengerCreateViewModel(IUserPassengerManager passengerManager, ICheckoutPassengerManager checkoutPassengerManager, IConfigurationManager configurationManager, SavedStateHandle savedStateHandle) {
        ...
        CheckoutPassengerCreateScreenNavArgs argsFrom = CheckoutPassengerCreateScreenDestination.INSTANCE.argsFrom(savedStateHandle);
        ...
        this.departureDirection = argsFrom.getDirection();
    ...
    public void registerPassenger(Function0<Unit> proceed) {
        ...
        BuildersKt__Builders_commonKt.launch$default(ViewModelKt.getViewModelScope(this), null, null, new CheckoutPassengerCreateViewModel$registerPassenger$1(this, proceed, null), 3, null);
    }
