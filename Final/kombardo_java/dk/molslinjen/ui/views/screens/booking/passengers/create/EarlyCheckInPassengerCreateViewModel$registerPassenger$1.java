...
@DebugMetadata(c = "dk.molslinjen.ui.views.screens.booking.passengers.create.EarlyCheckInPassengerCreateViewModel$registerPassenger$1", f = "EarlyCheckInPassengerCreateViewModel.kt", l = {46, 57, 59}, m = "invokeSuspend")
/* loaded from: classes2.dex */
public final class EarlyCheckInPassengerCreateViewModel$registerPassenger$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ Function0<Unit> $proceed;
    Object L$0;
    int label;
    final /* synthetic */ EarlyCheckInPassengerCreateViewModel this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public EarlyCheckInPassengerCreateViewModel$registerPassenger$1(EarlyCheckInPassengerCreateViewModel earlyCheckInPassengerCreateViewModel, Function0<Unit> function0, Continuation<? super EarlyCheckInPassengerCreateViewModel$registerPassenger$1> continuation) {
        super(2, continuation);
        this.this$0 = earlyCheckInPassengerCreateViewModel;
        this.$proceed = function0;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new EarlyCheckInPassengerCreateViewModel$registerPassenger$1(this.this$0, this.$proceed, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            if (i5 != 1) {
                ...
                this.L$0 = null;
                this.label = 3;
                if (iEarlyCheckInPassengerManager.addPassenger(bookingPassenger, z5, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                this.$proceed.invoke();
                return Unit.INSTANCE;
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((EarlyCheckInPassengerCreateViewModel$registerPassenger$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
