...
public final class CheckoutPassengerEditViewModel extends ViewModel implements IPassengerInputHandler {
    ...
    private final CheckoutPassengerEditScreenNavArgs navArgs;
    ...
    public CheckoutPassengerEditViewModel(IUserPassengerManager passengersManager, ICheckoutPassengerManager checkoutPassengerManager, IConfigurationManager configurationManager, SavedStateHandle savedStateHandle) {
        Object obj;
        Object obj2;
        ...
        CheckoutPassengerEditScreenNavArgs argsFrom = CheckoutPassengerEditScreenDestination.INSTANCE.argsFrom(savedStateHandle);
        ...
        this.departureDirection = direction;
        this.site = argsFrom.getSite();
        String passengerLocalId = argsFrom.getPassengerLocalId();
        StateFlow<PassengerSelectionHelper.PassengerState> passengerState = checkoutPassengerManager.passengerState(direction);
    ...
    public void deletePassenger(Function0<Unit> finishFlow) {
        ...
        BuildersKt__Builders_commonKt.launch$default(ViewModelKt.getViewModelScope(this), null, null, new CheckoutPassengerEditViewModel$deletePassenger$1(this, finishFlow, null), 3, null);
    }
    ...
    public Job updatePassenger(Function0<Unit> finishFlow) {
        Job launch$default;
        Intrinsics.checkNotNullParameter(finishFlow, "finishFlow");
        launch$default = BuildersKt__Builders_commonKt.launch$default(ViewModelKt.getViewModelScope(this), null, null, new CheckoutPassengerEditViewModel$updatePassenger$1(this, finishFlow, null), 3, null);
