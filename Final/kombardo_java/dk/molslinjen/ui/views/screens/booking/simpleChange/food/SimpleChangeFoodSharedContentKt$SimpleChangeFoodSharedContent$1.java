...
final class SimpleChangeFoodSharedContentKt$SimpleChangeFoodSharedContent$1 implements Function2<Composer, Integer, Unit> {
    ...
    final /* synthetic */ SimpleChangeFoodViewModel.ViewState $state;
    final /* synthetic */ SimpleChangeFoodViewModel $viewModel;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: Multi-variable type inference failed */
    public SimpleChangeFoodSharedContentKt$SimpleChangeFoodSharedContent$1(Booking booking, List<? extends Product> list, SimpleChangeFoodViewModel.ViewState viewState, SimpleChangeCheckoutManager.SimpleChangeCheckoutState simpleChangeCheckoutState, Function0<Unit> function0, SimpleChangeFoodViewModel simpleChangeFoodViewModel) {
        this.$existingBooking = booking;
        this.$selectedProducts = list;
        this.$state = viewState;
        this.$simpleChangeCheckoutState = simpleChangeCheckoutState;
        this.$proceed = function0;
        this.$viewModel = simpleChangeFoodViewModel;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit invoke$lambda$3$lambda$2$lambda$1(SimpleChangeFoodViewModel simpleChangeFoodViewModel) {
        simpleChangeFoodViewModel.showSnackbar(new SnackbarEvent.Information(new SnackbarText.ResourceText(R.string.food_add_noneSelected), null, false, 6, null));
    ...
    public final void invoke(Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1128163156, i5, -1, "dk.molslinjen.ui.views.screens.booking.simpleChange.food.SimpleChangeFoodSharedContent.<anonymous> (SimpleChangeFoodSharedContent.kt:44)");
        }
        ...
        SimpleChangeFoodViewModel.ViewState viewState = this.$state;
        ...
        final SimpleChangeFoodViewModel simpleChangeFoodViewModel = this.$viewModel;
        ...
        if (viewState.getPreselectedFood() && list != null && list.isEmpty()) {
            composer.startReplaceGroup(832698815);
            ...
            composer.startReplaceGroup(832702583);
            stringResource = StringResources_androidKt.stringResource(R.string.button_add, composer, 6);
            composer.endReplaceGroup();
        } else {
            composer.startReplaceGroup(832704784);
            stringResource = StringResources_androidKt.stringResource(R.string.checkout_buttonBar_proceedToPayment, composer, 6);
            composer.endReplaceGroup();
        }
        String str = stringResource;
        boolean z5 = viewState.getPreselectedFood() || (list != null && (list.isEmpty() ^ true));
        composer.startReplaceGroup(832714384);
        boolean changedInstance = composer.changedInstance(simpleChangeFoodViewModel);
        Object rememberedValue = composer.rememberedValue();
        if (changedInstance || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = new Function0() { // from class: dk.molslinjen.ui.views.screens.booking.simpleChange.food.a
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    Unit invoke$lambda$3$lambda$2$lambda$1;
                    invoke$lambda$3$lambda$2$lambda$1 = SimpleChangeFoodSharedContentKt$SimpleChangeFoodSharedContent$1.invoke$lambda$3$lambda$2$lambda$1(SimpleChangeFoodViewModel.this);
