...
@DebugMetadata(c = "dk.molslinjen.ui.views.screens.booking.passengers.edit.EarlyCheckInPassengerEditViewModel$updatePassenger$1", f = "EarlyCheckInPassengerEditViewModel.kt", l = {96, 109, 127}, m = "invokeSuspend")
/* loaded from: classes2.dex */
public final class EarlyCheckInPassengerEditViewModel$updatePassenger$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public EarlyCheckInPassengerEditViewModel$updatePassenger$1(EarlyCheckInPassengerEditViewModel earlyCheckInPassengerEditViewModel, Function0<Unit> function0, Continuation<? super EarlyCheckInPassengerEditViewModel$updatePassenger$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new EarlyCheckInPassengerEditViewModel$updatePassenger$1(this.this$0, this.$finishFlow, continuation);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            if (i5 != 1) {
                ...
                UserPassenger userPassenger5 = new UserPassenger(localId, remoteId, str4, str3, gender2, localDate2, country, userPassenger4.isCurrentUser());
        ...
        this.L$4 = nationality;
        this.label = 2;
        if (iEarlyCheckInPassengerManager.updatePassenger(bookingPassenger5, this) == coroutine_suspended) {
            return coroutine_suspended;
        }
        str4 = str10;
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((EarlyCheckInPassengerEditViewModel$updatePassenger$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
