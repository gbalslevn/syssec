...
import dk.molslinjen.ui.views.screens.booking.departures.DeparturesMultiRideScreenKt;
...
public abstract class DeparturesMultiRideScreenKt {
    public static final void DeparturesMultiRideScreen(final DeparturesViewModel viewModel, final DestinationsNavigator navigator, final ResultRecipient<CalendarScreenDestination, LocalDate> calendarResultRecipient, final ResultRecipient<TransportationSelectorScreenDestination, Boolean> transportationSelectorResultRecipient, final ResultRecipient<TicketTypeScreenDestination, UUID> onOutboundDepartureSelectedResultRecipient, final ICheckoutExpirationDialogHandler checkoutExpirationDialogHandler, Composer composer, final int i5) {
        ...
        Composer startRestartGroup = composer.startRestartGroup(2061232804);
        if ((i5 & 6) == 0) {
        ...
        if ((74899 & i6) == 74898 && startRestartGroup.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(2061232804, i6, -1, "dk.molslinjen.ui.views.screens.booking.departures.DeparturesMultiRideScreen (DeparturesMultiRideScreen.kt:31)");
            }
            startRestartGroup.startReplaceGroup(-704605109);
            ...
            startRestartGroup.startReplaceGroup(-704603467);
            Object rememberedValue2 = startRestartGroup.rememberedValue();
            if (rememberedValue2 == companion.getEmpty()) {
                rememberedValue2 = new Function0() { // from class: J2.v
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        Unit DeparturesMultiRideScreen$lambda$2$lambda$1;
                        DeparturesMultiRideScreen$lambda$2$lambda$1 = DeparturesMultiRideScreenKt.DeparturesMultiRideScreen$lambda$2$lambda$1(MutableState.this);
                        return DeparturesMultiRideScreen$lambda$2$lambda$1;
                    }
                };
            ...
            startRestartGroup.startReplaceGroup(-704599838);
            boolean changedInstance = startRestartGroup.changedInstance(viewModel) | ((i6 & 112) == 32);
            Object rememberedValue3 = startRestartGroup.rememberedValue();
            if (changedInstance || rememberedValue3 == companion.getEmpty()) {
                rememberedValue3 = new Function0() { // from class: J2.w
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        Unit DeparturesMultiRideScreen$lambda$4$lambda$3;
                        DeparturesMultiRideScreen$lambda$4$lambda$3 = DeparturesMultiRideScreenKt.DeparturesMultiRideScreen$lambda$4$lambda$3(DeparturesViewModel.this, navigator);
                        return DeparturesMultiRideScreen$lambda$4$lambda$3;
                    }
                };
                startRestartGroup.updateRememberedValue(rememberedValue3);
            }
            startRestartGroup.endReplaceGroup();
            CheckoutMultiRideFlowTopBarKt.AbortMultiRideFlowDialog(mutableState, (Function0) rememberedValue3, startRestartGroup, 6);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: J2.x
                ...
                public final Object invoke(Object obj, Object obj2) {
                    Unit DeparturesMultiRideScreen$lambda$5;
                    DeparturesMultiRideScreen$lambda$5 = DeparturesMultiRideScreenKt.DeparturesMultiRideScreen$lambda$5(DeparturesViewModel.this, navigator, calendarResultRecipient, transportationSelectorResultRecipient, onOutboundDepartureSelectedResultRecipient, checkoutExpirationDialogHandler, i5, (Composer) obj, ((Integer) obj2).intValue());
                    return DeparturesMultiRideScreen$lambda$5;
                }
            });
        }
    }
    ...
    public static final Unit DeparturesMultiRideScreen$lambda$2$lambda$1(MutableState mutableState) {
        mutableState.setValue(Boolean.TRUE);
        return Unit.INSTANCE;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit DeparturesMultiRideScreen$lambda$4$lambda$3(DeparturesViewModel departuresViewModel, DestinationsNavigator destinationsNavigator) {
        MultiRideFlowStickyTopBarWrapper.INSTANCE.abortMultiRideFlow(departuresViewModel, destinationsNavigator);
        return Unit.INSTANCE;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit DeparturesMultiRideScreen$lambda$5(DeparturesViewModel departuresViewModel, DestinationsNavigator destinationsNavigator, ResultRecipient resultRecipient, ResultRecipient resultRecipient2, ResultRecipient resultRecipient3, ICheckoutExpirationDialogHandler iCheckoutExpirationDialogHandler, int i5, Composer composer, int i6) {
        DeparturesMultiRideScreen(departuresViewModel, destinationsNavigator, resultRecipient, resultRecipient2, resultRecipient3, iCheckoutExpirationDialogHandler, composer, RecomposeScopeImplKt.updateChangedFlags(i5 | 1));
        return Unit.INSTANCE;
    }
}
