...
public abstract class DeparturesEditScreenKt {
    public static final void DeparturesEditScreen(final DeparturesViewModel viewModel, final DestinationsNavigator navigator, final ResultRecipient<CalendarScreenDestination, LocalDate> calendarResultRecipient, final ResultRecipient<TransportationSelectorScreenDestination, Boolean> transportationSelectorResultRecipient, final ResultRecipient<TicketTypeScreenDestination, UUID> onOutboundDepartureSelectedResultRecipient, final ICheckoutExpirationDialogHandler checkoutExpirationDialogHandler, Composer composer, final int i5) {
        ...
        Composer startRestartGroup = composer.startRestartGroup(-1620853916);
        if ((i5 & 6) == 0) {
        ...
        if ((74899 & i6) == 74898 && startRestartGroup.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1620853916, i6, -1, "dk.molslinjen.ui.views.screens.booking.departures.DeparturesEditScreen (DeparturesEditScreen.kt:31)");
            }
            startRestartGroup.startReplaceGroup(1949136556);
            ...
            startRestartGroup.startReplaceGroup(1949138198);
            Object rememberedValue2 = startRestartGroup.rememberedValue();
            if (rememberedValue2 == companion.getEmpty()) {
                rememberedValue2 = new Function0() { // from class: J2.s
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        Unit DeparturesEditScreen$lambda$2$lambda$1;
                        DeparturesEditScreen$lambda$2$lambda$1 = DeparturesEditScreenKt.DeparturesEditScreen$lambda$2$lambda$1(MutableState.this);
                        return DeparturesEditScreen$lambda$2$lambda$1;
                    }
                };
            ...
            startRestartGroup.startReplaceGroup(1949141497);
            boolean changedInstance = startRestartGroup.changedInstance(viewModel) | ((i6 & 112) == 32);
            Object rememberedValue3 = startRestartGroup.rememberedValue();
            if (changedInstance || rememberedValue3 == companion.getEmpty()) {
                rememberedValue3 = new Function0() { // from class: J2.t
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        Unit DeparturesEditScreen$lambda$4$lambda$3;
                        DeparturesEditScreen$lambda$4$lambda$3 = DeparturesEditScreenKt.DeparturesEditScreen$lambda$4$lambda$3(DeparturesViewModel.this, navigator);
                        return DeparturesEditScreen$lambda$4$lambda$3;
                    }
                };
                startRestartGroup.updateRememberedValue(rememberedValue3);
            }
            startRestartGroup.endReplaceGroup();
            CheckoutEditFlowTopBarKt.AbortEditFlowDialog(mutableState, (Function0) rememberedValue3, startRestartGroup, 6);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: J2.u
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    Unit DeparturesEditScreen$lambda$5;
                    DeparturesEditScreen$lambda$5 = DeparturesEditScreenKt.DeparturesEditScreen$lambda$5(DeparturesViewModel.this, navigator, calendarResultRecipient, transportationSelectorResultRecipient, onOutboundDepartureSelectedResultRecipient, checkoutExpirationDialogHandler, i5, (Composer) obj, ((Integer) obj2).intValue());
                    return DeparturesEditScreen$lambda$5;
                }
            });
        }
    }
    ...
    public static final Unit DeparturesEditScreen$lambda$2$lambda$1(MutableState mutableState) {
        mutableState.setValue(Boolean.TRUE);
        return Unit.INSTANCE;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit DeparturesEditScreen$lambda$4$lambda$3(DeparturesViewModel departuresViewModel, DestinationsNavigator destinationsNavigator) {
        EditFlowStickyTopBarWrapper.INSTANCE.abortEditFlow(departuresViewModel, destinationsNavigator);
        return Unit.INSTANCE;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit DeparturesEditScreen$lambda$5(DeparturesViewModel departuresViewModel, DestinationsNavigator destinationsNavigator, ResultRecipient resultRecipient, ResultRecipient resultRecipient2, ResultRecipient resultRecipient3, ICheckoutExpirationDialogHandler iCheckoutExpirationDialogHandler, int i5, Composer composer, int i6) {
        DeparturesEditScreen(departuresViewModel, destinationsNavigator, resultRecipient, resultRecipient2, resultRecipient3, iCheckoutExpirationDialogHandler, composer, RecomposeScopeImplKt.updateChangedFlags(i5 | 1));
        return Unit.INSTANCE;
    }
}
