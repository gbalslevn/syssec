...
public final /* data */ class AddonsScreenNavArgs {
    private final DepartureDirection departureDirection;

    public AddonsScreenNavArgs(DepartureDirection departureDirection) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof AddonsScreenNavArgs) && this.departureDirection == ((AddonsScreenNavArgs) other).departureDirection;
    }
    ...
    public String toString() {
        return "AddonsScreenNavArgs(departureDirection=" + this.departureDirection + ")";
    }
}
