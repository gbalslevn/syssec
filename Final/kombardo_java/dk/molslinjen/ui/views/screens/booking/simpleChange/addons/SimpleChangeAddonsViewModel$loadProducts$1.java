...
@DebugMetadata(c = "dk.molslinjen.ui.views.screens.booking.simpleChange.addons.SimpleChangeAddonsViewModel$loadProducts$1", f = "SimpleChangeAddonsViewModel.kt", l = {49, 59}, m = "invokeSuspend")
/* loaded from: classes2.dex */
public final class SimpleChangeAddonsViewModel$loadProducts$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ Booking $booking;
    final /* synthetic */ List<Product> $preselectedAddons;
    int label;
    ...
    public SimpleChangeAddonsViewModel$loadProducts$1(SimpleChangeAddonsViewModel simpleChangeAddonsViewModel, Booking booking, List<? extends Product> list, Continuation<? super SimpleChangeAddonsViewModel$loadProducts$1> continuation) {
        super(2, continuation);
        this.this$0 = simpleChangeAddonsViewModel;
        this.$booking = booking;
        this.$preselectedAddons = list;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new SimpleChangeAddonsViewModel$loadProducts$1(this.this$0, this.$booking, this.$preselectedAddons, continuation);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            if (i5 != 1) {
                ...
                ResultKt.throwOnFailure(obj);
                for (Product product : this.$preselectedAddons) {
                    iAddonHelper2 = this.this$0.addonHelper;
                    iAddonHelper2.updateProductQuantity(product, product.getQuantity());
                }
                mutableStateFlow = this.this$0._viewState;
                booking = this.$booking;
                list = this.$preselectedAddons;
                do {
                    value = mutableStateFlow.getValue();
                } while (!mutableStateFlow.compareAndSet(value, ((SimpleChangeAddonsViewModel.ViewState) value).copy(false, booking.getTicket().getPassengerInfo().getTotalPassengerCount(), CollectionsKt.any(list))));
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((SimpleChangeAddonsViewModel$loadProducts$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
