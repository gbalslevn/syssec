...
@DebugMetadata(c = "dk.molslinjen.ui.views.screens.saleOnBoard.basket.SaleOnBoardBasketViewModel$setupTimeSlotListener$1", f = "SaleOnBoardBasketViewModel.kt", l = {100}, m = "invokeSuspend")
/* loaded from: classes2.dex */
public final class SaleOnBoardBasketViewModel$setupTimeSlotListener$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    ...
    @DebugMetadata(c = "dk.molslinjen.ui.views.screens.saleOnBoard.basket.SaleOnBoardBasketViewModel$setupTimeSlotListener$1$1", f = "SaleOnBoardBasketViewModel.kt", l = {}, m = "invokeSuspend")
    /* renamed from: dk.molslinjen.ui.views.screens.saleOnBoard.basket.SaleOnBoardBasketViewModel$setupTimeSlotListener$1$1, reason: invalid class name */
    /* loaded from: classes2.dex */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<SaleOnBoardCheckoutManager.SaleOnBoardCheckoutState, Continuation<? super Unit>, Object> {
        ...
        AnonymousClass1(SaleOnBoardBasketViewModel saleOnBoardBasketViewModel, Continuation<? super AnonymousClass1> continuation) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            Object value;
            SaleOnBoardBasketViewModel.ViewState viewState;
            Object obj2;
            ...
            if (selectedStore != null) {
                ...
                do {
                    ...
                    viewState = (SaleOnBoardBasketViewModel.ViewState) value;
                ...
                } while (!mutableStateFlow.compareAndSet(value, SaleOnBoardBasketViewModel.ViewState.copy$default(viewState, false, false, emptyList, null, null, false, null, null, null, 507, null)));
            }
            return Unit.INSTANCE;
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SaleOnBoardBasketViewModel$setupTimeSlotListener$1(SaleOnBoardBasketViewModel saleOnBoardBasketViewModel, Continuation<? super SaleOnBoardBasketViewModel$setupTimeSlotListener$1> continuation) {
        super(2, continuation);
        this.this$0 = saleOnBoardBasketViewModel;
    }
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new SaleOnBoardBasketViewModel$setupTimeSlotListener$1(this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((SaleOnBoardBasketViewModel$setupTimeSlotListener$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
