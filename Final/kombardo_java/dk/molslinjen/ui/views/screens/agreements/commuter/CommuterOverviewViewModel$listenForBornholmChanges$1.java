...
@DebugMetadata(c = "dk.molslinjen.ui.views.screens.agreements.commuter.CommuterOverviewViewModel$listenForBornholmChanges$1", f = "CommuterOverviewViewModel.kt", l = {53}, m = "invokeSuspend")
/* loaded from: classes2.dex */
public final class CommuterOverviewViewModel$listenForBornholmChanges$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    ...
    @DebugMetadata(c = "dk.molslinjen.ui.views.screens.agreements.commuter.CommuterOverviewViewModel$listenForBornholmChanges$1$1", f = "CommuterOverviewViewModel.kt", l = {}, m = "invokeSuspend")
    /* renamed from: dk.molslinjen.ui.views.screens.agreements.commuter.CommuterOverviewViewModel$listenForBornholmChanges$1$1, reason: invalid class name */
    /* loaded from: classes2.dex */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<IBornholmCommuterManager.State, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            CommuterDataState<BornholmCommuterAgreement> agreementsState = ((IBornholmCommuterManager.State) this.L$0).getAgreementsState();
            mutableStateFlow = this.this$0._viewState;
            do {
                value = mutableStateFlow.getValue();
            } while (!mutableStateFlow.compareAndSet(value, CommuterOverviewViewModel.ViewState.copy$default((CommuterOverviewViewModel.ViewState) value, agreementsState instanceof CommuterDataState.Undetermined, CommuterDataStateExtensionsKt.getAgreements(agreementsState), agreementsState instanceof CommuterDataState.Error, false, null, false, 56, null)));
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CommuterOverviewViewModel$listenForBornholmChanges$1(CommuterOverviewViewModel commuterOverviewViewModel, Continuation<? super CommuterOverviewViewModel$listenForBornholmChanges$1> continuation) {
        super(2, continuation);
        this.this$0 = commuterOverviewViewModel;
    }
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new CommuterOverviewViewModel$listenForBornholmChanges$1(this.this$0, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ResultKt.throwOnFailure(obj);
            iBornholmCommuterManager = this.this$0.bornholmCommuterManager;
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((CommuterOverviewViewModel$listenForBornholmChanges$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
