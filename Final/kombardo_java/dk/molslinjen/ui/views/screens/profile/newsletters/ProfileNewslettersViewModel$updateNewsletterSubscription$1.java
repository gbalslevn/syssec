...
@DebugMetadata(c = "dk.molslinjen.ui.views.screens.profile.newsletters.ProfileNewslettersViewModel$updateNewsletterSubscription$1", f = "ProfileNewslettersViewModel.kt", l = {79, 92}, m = "invokeSuspend")
/* loaded from: classes2.dex */
public final class ProfileNewslettersViewModel$updateNewsletterSubscription$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ProfileNewslettersViewModel$updateNewsletterSubscription$1(ProfileNewslettersViewModel profileNewslettersViewModel, SiteInfo siteInfo, boolean z5, Continuation<? super ProfileNewslettersViewModel$updateNewsletterSubscription$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ProfileNewslettersViewModel$updateNewsletterSubscription$1(this.this$0, this.$siteInfo, this.$subscribe, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            this.label = 1;
            obj = iNewslettersManager.updateSubscription(str, site, boxBoolean, null, this);
        ...
        int i6 = this.$subscribe ? R.string.profile_newsletter_subscribed : R.string.profile_newsletter_unsubscribed;
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ProfileNewslettersViewModel$updateNewsletterSubscription$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
