...
public final class FieldType {
    ...
    private FieldType(String str, int i5, int i6, Collection collection, JavaType javaType) {
        int i7;
        this.id = i6;
        this.collection = collection;
        this.javaType = javaType;
        int i8 = AnonymousClass1.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        if (i8 == 1) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i7 = AnonymousClass1.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i7 == 2 || i7 == 3) ? false : true;
    }
