...
final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    public static int computeFieldSize(FieldDescriptorLite<?> fieldDescriptorLite, Object obj) {
        ...
        if (!fieldDescriptorLite.isPacked()) {
            ...
            while (it.hasNext()) {
                i5 += computeElementSize(liteType, number, it.next());
            }
            return i5;
        }
        if (list.isEmpty()) {
        ...
        return CodedOutputStream.computeTagSize(number) + i5 + CodedOutputStream.computeUInt32SizeNoTag(i5);
    }
