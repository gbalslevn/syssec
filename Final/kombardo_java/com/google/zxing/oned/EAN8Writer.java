...
public final class EAN8Writer extends UPCEANWriter {
    ...
    public boolean[] encode(String str) {
        ...
        for (int i5 = 0; i5 <= 3; i5++) {
            appendPattern += OneDimensionalCodeWriter.appendPattern(zArr, appendPattern, UPCEANReader.L_PATTERNS[Character.digit(str.charAt(i5), 10)], false);
        }
        ...
        for (int i6 = 4; i6 <= 7; i6++) {
            appendPattern2 += OneDimensionalCodeWriter.appendPattern(zArr, appendPattern2, UPCEANReader.L_PATTERNS[Character.digit(str.charAt(i6), 10)], true);
        }
