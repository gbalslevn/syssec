...
public abstract class zac {
    ...
    public static String zab(Context context, int i5) {
        Resources resources = context.getResources();
        return i5 != 1 ? i5 != 2 ? i5 != 3 ? resources.getString(R.string.ok) : resources.getString(R$string.common_google_play_services_enable_button) : resources.getString(R$string.common_google_play_services_update_button) : resources.getString(R$string.common_google_play_services_install_button);
    }
    ...
    public static String zad(Context context, int i5) {
        return (i5 == 6 || i5 == 19) ? zag(context, "common_google_play_services_resolution_required_text", zaa(context)) : zac(context, i5);
    }

    public static String zae(Context context, int i5) {
        String zah = i5 == 6 ? zah(context, "common_google_play_services_resolution_required_title") : zaf(context, i5);
