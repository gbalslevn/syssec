...
public class ComponentRuntime implements ComponentContainer, ComponentLoader {
    private static final Provider<Set<Object>> EMPTY_PROVIDER = new Provider() { // from class: E0.e
    ...
    public static final class Builder {
        ...
        public Builder addComponentRegistrar(final ComponentRegistrar componentRegistrar) {
            this.lazyRegistrars.add(new Provider() { // from class: E0.g
                @Override // com.google.firebase.inject.Provider
                public final Object get() {
    ...
    private void discoverComponents(List<Component<?>> list) {
        ...
        synchronized (this) {
            ...
            for (final Component<?> component : list) {
                this.components.put(component, new Lazy(new Provider() { // from class: E0.f
                    @Override // com.google.firebase.inject.Provider
                    public final Object get() {
    ...
    public void initializeEagerComponents(boolean z5) {
        HashMap hashMap;
        if (AbstractC0321h.a(this.eagerComponentsInitializedWith, null, Boolean.valueOf(z5))) {
            synchronized (this) {
