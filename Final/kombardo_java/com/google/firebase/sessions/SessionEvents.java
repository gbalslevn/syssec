...
public final class SessionEvents {
    ...
    public final ApplicationInfo getApplicationInfo(FirebaseApp firebaseApp) {
        ...
        return new ApplicationInfo(applicationId, MODEL, "2.0.8", RELEASE, logEnvironment, new AndroidApplicationInfo(packageName, str3, str, MANUFACTURER, currentProcessDetails, processDetailsProvider.getAppProcessDetails(applicationContext3)));
    }
