...
public final class MessagingClientEvent {
    ...
    public static final class Builder {
        ...
        private String message_id_ = BuildConfig.FLAVOR;
        private String instance_id_ = BuildConfig.FLAVOR;
        private MessageType message_type_ = MessageType.UNKNOWN;
        private SDKPlatform sdk_platform_ = SDKPlatform.UNKNOWN_OS;
        private String package_name_ = BuildConfig.FLAVOR;
        private String collapse_key_ = BuildConfig.FLAVOR;
        private int priority_ = 0;
        private int ttl_ = 0;
        private String topic_ = BuildConfig.FLAVOR;
        private long bulk_id_ = 0;
        private Event event_ = Event.UNKNOWN_EVENT;
        private String analytics_label_ = BuildConfig.FLAVOR;
        private long campaign_id_ = 0;
        private String composer_label_ = BuildConfig.FLAVOR;
