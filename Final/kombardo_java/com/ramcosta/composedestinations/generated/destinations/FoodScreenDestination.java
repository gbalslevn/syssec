...
import dk.molslinjen.ui.views.screens.booking.food.FoodScreenNavArgs;
...
public final /* data */ class FoodScreenDestination extends BaseRoute implements TypedDestinationSpec<FoodScreenNavArgs> {
    ...
    public void Content(final DestinationScope<FoodScreenNavArgs> destinationScope, Composer composer, int i5) {
        Intrinsics.checkNotNullParameter(destinationScope, "<this>");
        composer.startReplaceGroup(-1520597745);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1520597745, i5, -1, "com.ramcosta.composedestinations.generated.destinations.FoodScreenDestination.Content (FoodScreenDestination.kt:56)");
        }
        int i6 = i5 & 14;
        final DestinationDependenciesContainer buildDependencies = destinationScope.buildDependencies(composer, i6);
        DestinationWrapperKt.Wrap(destinationScope, new DestinationWrapper[]{CheckoutStickyTopBarWrapper.INSTANCE, EditFlowStickyTopBarWrapper.INSTANCE, SingleReturnFlowStickyTopBarWrapper.INSTANCE, MultiRideFlowStickyTopBarWrapper.INSTANCE, CommuterFlowStickyTopBarWrapper.INSTANCE}, ComposableLambdaKt.rememberComposableLambda(-2061749385, true, new Function2<Composer, Integer, Unit>() { // from class: com.ramcosta.composedestinations.generated.destinations.FoodScreenDestination$Content$1
            ...
            public final void invoke(Composer composer2, int i7) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-2061749385, i7, -1, "com.ramcosta.composedestinations.generated.destinations.FoodScreenDestination.Content.<anonymous> (FoodScreenDestination.kt:59)");
                }
                FoodScreenKt.FoodScreen((FoodViewModel) ((DestinationDependenciesContainerImpl) DestinationDependenciesContainer.this).require(Reflection.getOrCreateKotlinClass(FoodViewModel.class), false), destinationScope.getDestinationsNavigator(), (ICheckoutExpirationDialogHandler) ((DestinationDependenciesContainerImpl) DestinationDependenciesContainer.this).require(Reflection.getOrCreateKotlinClass(ICheckoutExpirationDialogHandler.class), false), composer2, 0);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public List<NamedNavArgument> getArguments() {
        return CollectionsKt.listOf(NamedNavArgumentKt.navArgument("departureDirection", new Function1() { // from class: f1.V
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                Unit _get_arguments_$lambda$1;
                _get_arguments_$lambda$1 = FoodScreenDestination._get_arguments_$lambda$1((NavArgumentBuilder) obj);
    ...
    public String toString() {
        return "FoodScreenDestination";
    }

    @Override // com.ramcosta.composedestinations.spec.TypedRoute
    public Direction invoke(FoodScreenNavArgs navArgs) {
    ...
    public FoodScreenNavArgs argsFrom(Bundle bundle) {
        ...
        if (departureDirection != null) {
            return new FoodScreenNavArgs(departureDirection);
        }
    ...
    @Override // com.ramcosta.composedestinations.spec.TypedDestinationSpec, com.ramcosta.composedestinations.spec.TypedRoute
    public FoodScreenNavArgs argsFrom(SavedStateHandle savedStateHandle) {
