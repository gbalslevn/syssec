...
public final /* data */ class BornholmCommuterAddScreenDestination extends BaseRoute implements DirectionDestinationSpec {
    ...
    public void Content(DestinationScope<Unit> destinationScope, Composer composer, int i5) {
        ...
        composer.startReplaceGroup(-1988984757);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1988984757, i5, -1, "com.ramcosta.composedestinations.generated.destinations.BornholmCommuterAddScreenDestination.Content (BornholmCommuterAddScreenDestination.kt:29)");
        }
        ...
        BornholmCommuterAddScreenKt.BornholmCommuterAddScreen((BornholmCommuterAddViewModel) destinationDependenciesContainerImpl.require(Reflection.getOrCreateKotlinClass(BornholmCommuterAddViewModel.class), false), destinationScope.getDestinationsNavigator(), destinationScope.getNavController(), destinationScope.getNavBackStackEntry(), (BottomSheetDismissHandler) destinationDependenciesContainerImpl.require(Reflection.getOrCreateKotlinClass(BottomSheetDismissHandler.class), false), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public String toString() {
        return "BornholmCommuterAddScreenDestination";
    }

    @Override // com.ramcosta.composedestinations.spec.TypedDestinationSpec, com.ramcosta.composedestinations.spec.TypedRoute
    public /* bridge */ /* synthetic */ Object argsFrom(SavedStateHandle savedStateHandle) {
        m3040argsFrom(savedStateHandle);
        return Unit.INSTANCE;
    }
    ...
    public void m3039argsFrom(Bundle bundle) {
        DirectionDestinationSpec.DefaultImpls.argsFrom(this, bundle);
    }

    /* renamed from: argsFrom, reason: collision with other method in class */
    public void m3040argsFrom(SavedStateHandle savedStateHandle) {
