...
@Metadata(d1 = {"\u0000P\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\bÇ\n\u0018\u00002\u00020\u00012\b\u0012\u0004\u0012\u00020\u00030\u0002B\t\b\u0002¢\u0006\u0004\b\u0004\u0010\u0005J\u0011\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\u0003H\u0096\u0002J\u0013\u0010\u0006\u001a\u00020\u00072\b\b\u0002\u0010\t\u001a\u00020\nH\u0086\u0002J\u0017\u0010\u0016\u001a\u00020\u0017*\b\u0012\u0004\u0012\u00020\u00030\u0018H\u0017¢\u0006\u0002\u0010\u0019J\u0012\u0010\u001a\u001a\u00020\u00032\b\u0010\u001b\u001a\u0004\u0018\u00010\u001cH\u0016J\u0010\u0010\u001a\u001a\u00020\u00032\u0006\u0010\u001d\u001a\u00020\u001eH\u0016J\t\u0010\u001f\u001a\u00020\fHÖ\u0001R\u0014\u0010\u000b\u001a\u00020\fX\u0096D¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000eR\u0014\u0010\u000f\u001a\u00020\fX\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0010\u0010\u000eR\u001a\u0010\u0011\u001a\b\u0012\u0004\u0012\u00020\u00130\u00128VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\u0014\u0010\u0015¨\u0006 "}, d2 = {"Lcom/ramcosta/composedestinations/generated/destinations/DeparturesCommuterScreenDestination;", "Lcom/ramcosta/composedestinations/spec/BaseRoute;", "Lcom/ramcosta/composedestinations/spec/TypedDestinationSpec;", "Ldk/molslinjen/ui/views/screens/booking/departures/DeparturesScreenNavArgs;", "<init>", "()V", "invoke", "Lcom/ramcosta/composedestinations/spec/Direction;", "navArgs", "isAddingReturnFromBookingSummary", BuildConfig.FLAVOR, "baseRoute", BuildConfig.FLAVOR, "getBaseRoute", "()Ljava/lang/String;", "route", "getRoute", "arguments", BuildConfig.FLAVOR, "Landroidx/navigation/NamedNavArgument;", "getArguments", "()Ljava/util/List;", "Content", BuildConfig.FLAVOR, "Lcom/ramcosta/composedestinations/scope/DestinationScope;", "(Lcom/ramcosta/composedestinations/scope/DestinationScope;Landroidx/compose/runtime/Composer;I)V", "argsFrom", "bundle", "Landroid/os/Bundle;", "savedStateHandle", "Landroidx/lifecycle/SavedStateHandle;", "toString", "app_kombardoProd"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes2.dex */
public final /* data */ class DeparturesCommuterScreenDestination extends BaseRoute implements TypedDestinationSpec<DeparturesScreenNavArgs> {
    public static final DeparturesCommuterScreenDestination INSTANCE;
    private static final String baseRoute;
    private static final String route;

    static {
        DeparturesCommuterScreenDestination departuresCommuterScreenDestination = new DeparturesCommuterScreenDestination();
        INSTANCE = departuresCommuterScreenDestination;
        baseRoute = "departures_commuter_screen";
        route = departuresCommuterScreenDestination.getBaseRoute() + "?isAddingReturnFromBookingSummary={isAddingReturnFromBookingSummary}";
    }

    private DeparturesCommuterScreenDestination() {
    }
    ...
    public static /* synthetic */ Direction invoke$default(DeparturesCommuterScreenDestination departuresCommuterScreenDestination, boolean z5, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            z5 = false;
        }
        return departuresCommuterScreenDestination.invoke(z5);
    }
    ...
    public void Content(final DestinationScope<DeparturesScreenNavArgs> destinationScope, Composer composer, int i5) {
        ...
        composer.startReplaceGroup(-1916305489);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1916305489, i5, -1, "com.ramcosta.composedestinations.generated.destinations.DeparturesCommuterScreenDestination.Content (DeparturesCommuterScreenDestination.kt:56)");
        }
        int i6 = i5 & 14;
        final DestinationDependenciesContainer buildDependencies = destinationScope.buildDependencies(composer, i6);
        DestinationWrapperKt.Wrap(destinationScope, CommuterFlowStickyTopBarWrapper.INSTANCE, ComposableLambdaKt.rememberComposableLambda(-1706425833, true, new Function2<Composer, Integer, Unit>() { // from class: com.ramcosta.composedestinations.generated.destinations.DeparturesCommuterScreenDestination$Content$1
            ...
            public final void invoke(Composer composer2, int i7) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-1706425833, i7, -1, "com.ramcosta.composedestinations.generated.destinations.DeparturesCommuterScreenDestination.Content.<anonymous> (DeparturesCommuterScreenDestination.kt:59)");
                }
                ...
                composer2.endReplaceGroup();
                DeparturesCommuterScreenKt.DeparturesCommuterScreen(departuresViewModel, destinationsNavigator, resultRecipient, resultRecipient2, resultRecipient3, (ICheckoutExpirationDialogHandler) ((DestinationDependenciesContainerImpl) DestinationDependenciesContainer.this).require(Reflection.getOrCreateKotlinClass(ICheckoutExpirationDialogHandler.class), false), composer2, 0);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public List<NamedNavArgument> getArguments() {
        return CollectionsKt.listOf(NamedNavArgumentKt.navArgument("isAddingReturnFromBookingSummary", new Function1() { // from class: f1.B
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                Unit _get_arguments_$lambda$1;
                _get_arguments_$lambda$1 = DeparturesCommuterScreenDestination._get_arguments_$lambda$1((NavArgumentBuilder) obj);
    ...
    public String toString() {
        return "DeparturesCommuterScreenDestination";
    }
