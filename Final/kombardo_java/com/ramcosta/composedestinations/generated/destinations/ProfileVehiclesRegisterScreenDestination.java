...
public final /* data */ class ProfileVehiclesRegisterScreenDestination extends BaseRoute implements DirectionDestinationSpec {
    ...
    public void Content(DestinationScope<Unit> destinationScope, Composer composer, int i5) {
        ...
        composer.startReplaceGroup(1473197057);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1473197057, i5, -1, "com.ramcosta.composedestinations.generated.destinations.ProfileVehiclesRegisterScreenDestination.Content (ProfileVehiclesRegisterScreenDestination.kt:29)");
        }
        ProfileVehiclesRegisterScreenKt.ProfileVehiclesRegisterScreen((ProfileVehiclesRegisterViewModel) ((DestinationDependenciesContainerImpl) destinationScope.buildDependencies(composer, i5 & 14)).require(Reflection.getOrCreateKotlinClass(ProfileVehiclesRegisterViewModel.class), false), destinationScope.getDestinationsNavigator(), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public String toString() {
        return "ProfileVehiclesRegisterScreenDestination";
    }

    @Override // com.ramcosta.composedestinations.spec.TypedDestinationSpec, com.ramcosta.composedestinations.spec.TypedRoute
    public /* bridge */ /* synthetic */ Object argsFrom(SavedStateHandle savedStateHandle) {
        m3127argsFrom(savedStateHandle);
        return Unit.INSTANCE;
    }
    ...
    public void m3126argsFrom(Bundle bundle) {
        DirectionDestinationSpec.DefaultImpls.argsFrom(this, bundle);
    }

    /* renamed from: argsFrom, reason: collision with other method in class */
    public void m3127argsFrom(SavedStateHandle savedStateHandle) {
