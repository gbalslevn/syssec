...
@Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u0005\bÇ\n\u0018\u00002\u00020\u00012\u00020\u0002B\t\b\u0002¢\u0006\u0004\b\u0003\u0010\u0004J\u0019\u0010\u0007\u001a\u00020\u0006*\b\u0012\u0004\u0012\u00020\u00060\u0005H\u0017¢\u0006\u0004\b\u0007\u0010\bJ\u0010\u0010\n\u001a\u00020\tHÖ\u0001¢\u0006\u0004\b\n\u0010\u000bR\u001a\u0010\f\u001a\u00020\t8\u0016X\u0096D¢\u0006\f\n\u0004\b\f\u0010\r\u001a\u0004\b\u000e\u0010\u000bR\u001a\u0010\u000f\u001a\u00020\t8\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\u000f\u0010\r\u001a\u0004\b\u0010\u0010\u000bR\u001a\u0010\u0012\u001a\u00020\u00118\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\u0012\u0010\u0013\u001a\u0004\b\u0014\u0010\u0015¨\u0006\u0016"}, d2 = {"Lcom/ramcosta/composedestinations/generated/destinations/EarlyCheckInProcessingScreenDestination;", "Lcom/ramcosta/composedestinations/spec/BaseRoute;", "Lcom/ramcosta/composedestinations/spec/DirectionDestinationSpec;", "<init>", "()V", "Lcom/ramcosta/composedestinations/scope/DestinationScope;", BuildConfig.FLAVOR, "Content", "(Lcom/ramcosta/composedestinations/scope/DestinationScope;Landroidx/compose/runtime/Composer;I)V", BuildConfig.FLAVOR, "toString", "()Ljava/lang/String;", "baseRoute", "Ljava/lang/String;", "getBaseRoute", "route", "getRoute", "Lcom/ramcosta/composedestinations/spec/DestinationStyle;", "style", "Lcom/ramcosta/composedestinations/spec/DestinationStyle;", "getStyle", "()Lcom/ramcosta/composedestinations/spec/DestinationStyle;", "app_kombardoProd"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes2.dex */
public final /* data */ class EarlyCheckInProcessingScreenDestination extends BaseRoute implements DirectionDestinationSpec {
    public static final int $stable;
    public static final EarlyCheckInProcessingScreenDestination INSTANCE;
    private static final String baseRoute;
    private static final String route;
    private static final DestinationStyle style;

    static {
        EarlyCheckInProcessingScreenDestination earlyCheckInProcessingScreenDestination = new EarlyCheckInProcessingScreenDestination();
        INSTANCE = earlyCheckInProcessingScreenDestination;
        baseRoute = "early_check_in_processing_screen";
        route = earlyCheckInProcessingScreenDestination.getBaseRoute();
        style = DestinationStyleBottomSheet.INSTANCE;
        $stable = DestinationStyle.$stable;
    }

    private EarlyCheckInProcessingScreenDestination() {
    }
    ...
    public void Content(DestinationScope<Unit> destinationScope, Composer composer, int i5) {
        ...
        composer.startReplaceGroup(-1850412817);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1850412817, i5, -1, "com.ramcosta.composedestinations.generated.destinations.EarlyCheckInProcessingScreenDestination.Content (EarlyCheckInProcessingScreenDestination.kt:31)");
        }
        int i6 = i5 & 14;
        ...
        EarlyCheckInProcessingScreenKt.EarlyCheckInProcessingScreen((EarlyCheckInProcessingViewModel) destinationDependenciesContainerImpl.require(Reflection.getOrCreateKotlinClass(EarlyCheckInProcessingViewModel.class), false), DestinationScopeKt.resultBackNavigator(destinationScope, DestinationsBooleanNavTypeKt.getBooleanNavType(), composer, i6 | (DestinationsNavType.$stable << 3)), destinationScope.getDestinationsNavigator(), destinationScope.getNavController(), destinationScope.getNavBackStackEntry(), (BottomSheetDismissHandler) destinationDependenciesContainerImpl.require(Reflection.getOrCreateKotlinClass(BottomSheetDismissHandler.class), false), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public String toString() {
        return "EarlyCheckInProcessingScreenDestination";
    }

    @Override // com.ramcosta.composedestinations.spec.TypedDestinationSpec, com.ramcosta.composedestinations.spec.TypedRoute
    public /* bridge */ /* synthetic */ Object argsFrom(SavedStateHandle savedStateHandle) {
        m3064argsFrom(savedStateHandle);
        return Unit.INSTANCE;
    }
    ...
    public void m3063argsFrom(Bundle bundle) {
        DirectionDestinationSpec.DefaultImpls.argsFrom(this, bundle);
    }

    /* renamed from: argsFrom, reason: collision with other method in class */
    public void m3064argsFrom(SavedStateHandle savedStateHandle) {
