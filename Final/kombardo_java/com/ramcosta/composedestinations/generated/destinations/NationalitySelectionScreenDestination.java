...
public final /* data */ class NationalitySelectionScreenDestination extends BaseRoute implements DirectionDestinationSpec {
    ...
    public void Content(DestinationScope<Unit> destinationScope, Composer composer, int i5) {
        ...
        composer.startReplaceGroup(-912403249);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-912403249, i5, -1, "com.ramcosta.composedestinations.generated.destinations.NationalitySelectionScreenDestination.Content (NationalitySelectionScreenDestination.kt:31)");
        }
        int i6 = i5 & 14;
        NationalitySelectionScreenKt.NationalitySelectionScreen((NationalitySelectionViewModel) ((DestinationDependenciesContainerImpl) destinationScope.buildDependencies(composer, i6)).require(Reflection.getOrCreateKotlinClass(NationalitySelectionViewModel.class), false), DestinationScopeKt.resultBackNavigator(destinationScope, LocaleNavTypeKt.getLocaleNavType(), composer, i6), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public String toString() {
        return "NationalitySelectionScreenDestination";
    }

    @Override // com.ramcosta.composedestinations.spec.TypedDestinationSpec, com.ramcosta.composedestinations.spec.TypedRoute
    public /* bridge */ /* synthetic */ Object argsFrom(SavedStateHandle savedStateHandle) {
        m3089argsFrom(savedStateHandle);
        return Unit.INSTANCE;
    }
    ...
    public void m3088argsFrom(Bundle bundle) {
        DirectionDestinationSpec.DefaultImpls.argsFrom(this, bundle);
    }

    /* renamed from: argsFrom, reason: collision with other method in class */
    public void m3089argsFrom(SavedStateHandle savedStateHandle) {
