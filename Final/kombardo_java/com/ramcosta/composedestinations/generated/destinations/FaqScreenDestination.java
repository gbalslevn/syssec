...
public final /* data */ class FaqScreenDestination extends BaseRoute implements DirectionDestinationSpec {
    ...
    public void Content(DestinationScope<Unit> destinationScope, Composer composer, int i5) {
        ...
        composer.startReplaceGroup(780474567);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(780474567, i5, -1, "com.ramcosta.composedestinations.generated.destinations.FaqScreenDestination.Content (FaqScreenDestination.kt:29)");
        }
        FaqScreenKt.FaqScreen((FaqViewModel) ((DestinationDependenciesContainerImpl) destinationScope.buildDependencies(composer, i5 & 14)).require(Reflection.getOrCreateKotlinClass(FaqViewModel.class), false), destinationScope.getDestinationsNavigator(), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public void m3067argsFrom(Bundle bundle) {
        DirectionDestinationSpec.DefaultImpls.argsFrom(this, bundle);
    }

    /* renamed from: argsFrom, reason: collision with other method in class */
    public void m3068argsFrom(SavedStateHandle savedStateHandle) {
