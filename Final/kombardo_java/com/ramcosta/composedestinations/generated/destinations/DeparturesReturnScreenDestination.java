...
public final /* data */ class DeparturesReturnScreenDestination extends BaseRoute implements TypedDestinationSpec<DeparturesScreenNavArgs> {
    ...
    public void Content(final DestinationScope<DeparturesScreenNavArgs> destinationScope, Composer composer, int i5) {
        ...
        composer.startReplaceGroup(1396968815);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1396968815, i5, -1, "com.ramcosta.composedestinations.generated.destinations.DeparturesReturnScreenDestination.Content (DeparturesReturnScreenDestination.kt:56)");
        }
        int i6 = i5 & 14;
        final DestinationDependenciesContainer buildDependencies = destinationScope.buildDependencies(composer, i6);
        DestinationWrapperKt.Wrap(destinationScope, SingleReturnFlowStickyTopBarWrapper.INSTANCE, ComposableLambdaKt.rememberComposableLambda(-520617001, true, new Function2<Composer, Integer, Unit>() { // from class: com.ramcosta.composedestinations.generated.destinations.DeparturesReturnScreenDestination$Content$1
            ...
            public final void invoke(Composer composer2, int i7) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-520617001, i7, -1, "com.ramcosta.composedestinations.generated.destinations.DeparturesReturnScreenDestination.Content.<anonymous> (DeparturesReturnScreenDestination.kt:59)");
                }
                ...
                composer2.startReplaceGroup(1363506722);
                ResultRecipient resultRecipient2 = ResultCommonsKt.resultRecipient(destinationScope3.getNavBackStackEntry(), Reflection.getOrCreateKotlinClass(CargoDetailsScreenDestination.class), booleanNavType, composer2, (i8 << 6) & 896);
                composer2.endReplaceGroup();
                ...
                composer2.startReplaceGroup(1363506722);
                ResultRecipient resultRecipient3 = ResultCommonsKt.resultRecipient(destinationScope4.getNavBackStackEntry(), Reflection.getOrCreateKotlinClass(TransportationSelectorScreenDestination.class), booleanNavType2, composer2, (i8 << 6) & 896);
                composer2.endReplaceGroup();
                DestinationScope<DeparturesScreenNavArgs> destinationScope5 = destinationScope;
                UUIDNavType uUIDNavType = UUIDNavTypeKt.getUUIDNavType();
                composer2.startReplaceGroup(1363506722);
                ResultRecipient resultRecipient4 = ResultCommonsKt.resultRecipient(destinationScope5.getNavBackStackEntry(), Reflection.getOrCreateKotlinClass(TicketTypeScreenDestination.class), uUIDNavType, composer2, 0);
                composer2.endReplaceGroup();
                DeparturesReturnScreenKt.DeparturesReturnScreen(departuresViewModel, destinationsNavigator, resultRecipient, resultRecipient2, resultRecipient3, resultRecipient4, (ICheckoutExpirationDialogHandler) ((DestinationDependenciesContainerImpl) DestinationDependenciesContainer.this).require(Reflection.getOrCreateKotlinClass(ICheckoutExpirationDialogHandler.class), false), composer2, 0);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public List<NamedNavArgument> getArguments() {
        return CollectionsKt.listOf(NamedNavArgumentKt.navArgument("isAddingReturnFromBookingSummary", new Function1() { // from class: f1.E
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                Unit _get_arguments_$lambda$1;
                _get_arguments_$lambda$1 = DeparturesReturnScreenDestination._get_arguments_$lambda$1((NavArgumentBuilder) obj);
    ...
    public String toString() {
        return "DeparturesReturnScreenDestination";
    }
