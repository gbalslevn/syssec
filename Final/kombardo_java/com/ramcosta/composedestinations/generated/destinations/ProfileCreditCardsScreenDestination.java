...
public final /* data */ class ProfileCreditCardsScreenDestination extends BaseRoute implements DirectionDestinationSpec {
    ...
    public void Content(DestinationScope<Unit> destinationScope, Composer composer, int i5) {
        ...
        composer.startReplaceGroup(-891386385);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-891386385, i5, -1, "com.ramcosta.composedestinations.generated.destinations.ProfileCreditCardsScreenDestination.Content (ProfileCreditCardsScreenDestination.kt:29)");
        }
        ProfileCreditCardsScreenKt.ProfileCreditCardsScreen((ProfileCreditCardsViewModel) ((DestinationDependenciesContainerImpl) destinationScope.buildDependencies(composer, i5 & 14)).require(Reflection.getOrCreateKotlinClass(ProfileCreditCardsViewModel.class), false), destinationScope.getDestinationsNavigator(), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public void m3114argsFrom(Bundle bundle) {
        DirectionDestinationSpec.DefaultImpls.argsFrom(this, bundle);
    }

    /* renamed from: argsFrom, reason: collision with other method in class */
    public void m3115argsFrom(SavedStateHandle savedStateHandle) {
