...
public final /* data */ class MultiRideCardPurchaseSummaryScreenDestination extends BaseRoute implements DirectionDestinationSpec {
    ...
    public void Content(DestinationScope<Unit> destinationScope, Composer composer, int i5) {
        ...
        composer.startReplaceGroup(478872655);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(478872655, i5, -1, "com.ramcosta.composedestinations.generated.destinations.MultiRideCardPurchaseSummaryScreenDestination.Content (MultiRideCardPurchaseSummaryScreenDestination.kt:31)");
        }
        int i6 = i5 & 14;
        MultiRidePurchaseSummaryViewModel multiRidePurchaseSummaryViewModel = (MultiRidePurchaseSummaryViewModel) ((DestinationDependenciesContainerImpl) destinationScope.buildDependencies(composer, i6)).require(Reflection.getOrCreateKotlinClass(MultiRidePurchaseSummaryViewModel.class), false);
        ...
        MultiRideCardPurchaseSummaryScreenKt.MultiRideCardPurchaseSummaryScreen(multiRidePurchaseSummaryViewModel, destinationsNavigator, resultRecipient, composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public String toString() {
        return "MultiRideCardPurchaseSummaryScreenDestination";
    }

    @Override // com.ramcosta.composedestinations.spec.TypedDestinationSpec, com.ramcosta.composedestinations.spec.TypedRoute
    public /* bridge */ /* synthetic */ Object argsFrom(SavedStateHandle savedStateHandle) {
        m3083argsFrom(savedStateHandle);
        return Unit.INSTANCE;
    }
    ...
    public void m3082argsFrom(Bundle bundle) {
        DirectionDestinationSpec.DefaultImpls.argsFrom(this, bundle);
    }

    /* renamed from: argsFrom, reason: collision with other method in class */
    public void m3083argsFrom(SavedStateHandle savedStateHandle) {
