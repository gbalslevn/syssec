...
@Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\b\bÇ\n\u0018\u00002\u00020\u00012\u00020\u0002B\t\b\u0002¢\u0006\u0004\b\u0003\u0010\u0004J\u0019\u0010\u0007\u001a\u00020\u0006*\b\u0012\u0004\u0012\u00020\u00060\u0005H\u0017¢\u0006\u0004\b\u0007\u0010\bJ\u0010\u0010\n\u001a\u00020\tHÖ\u0001¢\u0006\u0004\b\n\u0010\u000bR\u001a\u0010\f\u001a\u00020\t8\u0016X\u0096D¢\u0006\f\n\u0004\b\f\u0010\r\u001a\u0004\b\u000e\u0010\u000bR\u001a\u0010\u000f\u001a\u00020\t8\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\u000f\u0010\r\u001a\u0004\b\u0010\u0010\u000b¨\u0006\u0011"}, d2 = {"Lcom/ramcosta/composedestinations/generated/destinations/PassengerCountScreenDestination;", "Lcom/ramcosta/composedestinations/spec/BaseRoute;", "Lcom/ramcosta/composedestinations/spec/DirectionDestinationSpec;", "<init>", "()V", "Lcom/ramcosta/composedestinations/scope/DestinationScope;", BuildConfig.FLAVOR, "Content", "(Lcom/ramcosta/composedestinations/scope/DestinationScope;Landroidx/compose/runtime/Composer;I)V", BuildConfig.FLAVOR, "toString", "()Ljava/lang/String;", "baseRoute", "Ljava/lang/String;", "getBaseRoute", "route", "getRoute", "app_kombardoProd"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes2.dex */
public final /* data */ class PassengerCountScreenDestination extends BaseRoute implements DirectionDestinationSpec {
    public static final PassengerCountScreenDestination INSTANCE;
    private static final String baseRoute;
    private static final String route;

    static {
        PassengerCountScreenDestination passengerCountScreenDestination = new PassengerCountScreenDestination();
        INSTANCE = passengerCountScreenDestination;
        baseRoute = "passenger_count_screen";
        route = passengerCountScreenDestination.getBaseRoute();
    }

    private PassengerCountScreenDestination() {
    }
    ...
    public void Content(final DestinationScope<Unit> destinationScope, Composer composer, int i5) {
        ...
        DestinationWrapperKt.Wrap(destinationScope, new DestinationWrapper[]{CheckoutStickyTopBarWrapper.INSTANCE, EditFlowStickyTopBarWrapper.INSTANCE, SingleReturnFlowStickyTopBarWrapper.INSTANCE, MultiRideFlowStickyTopBarWrapper.INSTANCE, CommuterFlowStickyTopBarWrapper.INSTANCE}, ComposableLambdaKt.rememberComposableLambda(12097367, true, new Function2<Composer, Integer, Unit>() { // from class: com.ramcosta.composedestinations.generated.destinations.PassengerCountScreenDestination$Content$1
            ...
            public final void invoke(Composer composer2, int i7) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(12097367, i7, -1, "com.ramcosta.composedestinations.generated.destinations.PassengerCountScreenDestination.Content.<anonymous> (PassengerCountScreenDestination.kt:35)");
                }
                PassengerCountScreenKt.PassengerCountScreen((PassengerCountViewModel) ((DestinationDependenciesContainerImpl) DestinationDependenciesContainer.this).require(Reflection.getOrCreateKotlinClass(PassengerCountViewModel.class), false), destinationScope.getDestinationsNavigator(), (ICheckoutExpirationDialogHandler) ((DestinationDependenciesContainerImpl) DestinationDependenciesContainer.this).require(Reflection.getOrCreateKotlinClass(ICheckoutExpirationDialogHandler.class), false), composer2, 0);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public void m3100argsFrom(Bundle bundle) {
        DirectionDestinationSpec.DefaultImpls.argsFrom(this, bundle);
    }

    /* renamed from: argsFrom, reason: collision with other method in class */
    public void m3101argsFrom(SavedStateHandle savedStateHandle) {
