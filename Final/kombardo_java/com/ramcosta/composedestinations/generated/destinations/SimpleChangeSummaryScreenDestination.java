...
public final /* data */ class SimpleChangeSummaryScreenDestination extends BaseRoute implements DirectionDestinationSpec {
    ...
    public void Content(DestinationScope<Unit> destinationScope, Composer composer, int i5) {
        ...
        composer.startReplaceGroup(208645283);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(208645283, i5, -1, "com.ramcosta.composedestinations.generated.destinations.SimpleChangeSummaryScreenDestination.Content (SimpleChangeSummaryScreenDestination.kt:29)");
        }
        ...
        SimpleChangeSummaryScreenKt.SimpleChangeSummaryScreen((SimpleChangeSummaryViewModel) destinationDependenciesContainerImpl.require(Reflection.getOrCreateKotlinClass(SimpleChangeSummaryViewModel.class), false), destinationScope.getDestinationsNavigator(), destinationScope.getNavController(), destinationScope.getNavBackStackEntry(), (BottomSheetDismissHandler) destinationDependenciesContainerImpl.require(Reflection.getOrCreateKotlinClass(BottomSheetDismissHandler.class), false), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public String toString() {
        return "SimpleChangeSummaryScreenDestination";
    }

    @Override // com.ramcosta.composedestinations.spec.TypedDestinationSpec, com.ramcosta.composedestinations.spec.TypedRoute
    public /* bridge */ /* synthetic */ Object argsFrom(SavedStateHandle savedStateHandle) {
        m3155argsFrom(savedStateHandle);
        return Unit.INSTANCE;
    }
    ...
    public void m3154argsFrom(Bundle bundle) {
        DirectionDestinationSpec.DefaultImpls.argsFrom(this, bundle);
    }

    /* renamed from: argsFrom, reason: collision with other method in class */
    public void m3155argsFrom(SavedStateHandle savedStateHandle) {
