...
public final /* data */ class SimpleChangeAddonsScreenDestination extends BaseRoute implements DirectionDestinationSpec {
    ...
    public void Content(DestinationScope<Unit> destinationScope, Composer composer, int i5) {
        ...
        composer.startReplaceGroup(-1362326929);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1362326929, i5, -1, "com.ramcosta.composedestinations.generated.destinations.SimpleChangeAddonsScreenDestination.Content (SimpleChangeAddonsScreenDestination.kt:29)");
        }
        SimpleChangeAddonsScreenKt.SimpleChangeAddonsScreen((SimpleChangeAddonsViewModel) ((DestinationDependenciesContainerImpl) destinationScope.buildDependencies(composer, i5 & 14)).require(Reflection.getOrCreateKotlinClass(SimpleChangeAddonsViewModel.class), false), destinationScope.getDestinationsNavigator(), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public void m3148argsFrom(Bundle bundle) {
        DirectionDestinationSpec.DefaultImpls.argsFrom(this, bundle);
    }

    /* renamed from: argsFrom, reason: collision with other method in class */
    public void m3149argsFrom(SavedStateHandle savedStateHandle) {
