...
public final /* data */ class EarlyCheckInPassengerSelectorScreenDestination extends BaseRoute implements DirectionDestinationSpec {
    ...
    public void Content(DestinationScope<Unit> destinationScope, Composer composer, int i5) {
        ...
        composer.startReplaceGroup(-1211747015);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1211747015, i5, -1, "com.ramcosta.composedestinations.generated.destinations.EarlyCheckInPassengerSelectorScreenDestination.Content (EarlyCheckInPassengerSelectorScreenDestination.kt:29)");
        }
        EarlyCheckInPassengerSelectorScreenKt.EarlyCheckInPassengerSelectorScreen((EarlyCheckInPassengerSelectorViewModel) ((DestinationDependenciesContainerImpl) destinationScope.buildDependencies(composer, i5 & 14)).require(Reflection.getOrCreateKotlinClass(EarlyCheckInPassengerSelectorViewModel.class), false), destinationScope.getDestinationsNavigator(), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public String toString() {
        return "EarlyCheckInPassengerSelectorScreenDestination";
    }

    @Override // com.ramcosta.composedestinations.spec.TypedDestinationSpec, com.ramcosta.composedestinations.spec.TypedRoute
    public /* bridge */ /* synthetic */ Object argsFrom(SavedStateHandle savedStateHandle) {
        m3062argsFrom(savedStateHandle);
        return Unit.INSTANCE;
    }
    ...
    public void m3061argsFrom(Bundle bundle) {
        DirectionDestinationSpec.DefaultImpls.argsFrom(this, bundle);
    }

    /* renamed from: argsFrom, reason: collision with other method in class */
    public void m3062argsFrom(SavedStateHandle savedStateHandle) {
