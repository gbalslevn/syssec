...
public final class LocalDateNavType extends DestinationsNavType<LocalDate> {
    ...
    @Override // androidx.navigation.NavType
    public LocalDate get(Bundle bundle, String key) {
        Intrinsics.checkNotNullParameter(bundle, "bundle");
        Intrinsics.checkNotNullParameter(key, "key");
        return (LocalDate) bundle.getSerializable(key);
    }

    @Override // androidx.navigation.NavType
    public void put(Bundle bundle, String key, LocalDate value) {
        Intrinsics.checkNotNullParameter(bundle, "bundle");
        Intrinsics.checkNotNullParameter(key, "key");
    ...
    @Override // com.ramcosta.composedestinations.navargs.DestinationsNavType
    public LocalDate get(SavedStateHandle savedStateHandle, String key) {
        Intrinsics.checkNotNullParameter(savedStateHandle, "savedStateHandle");
        Intrinsics.checkNotNullParameter(key, "key");
        return (LocalDate) savedStateHandle.get(key);
    }

    @Override // com.ramcosta.composedestinations.navargs.DestinationsNavType
    public void put(SavedStateHandle savedStateHandle, String key, LocalDate value) {
        Intrinsics.checkNotNullParameter(savedStateHandle, "savedStateHandle");
        Intrinsics.checkNotNullParameter(key, "key");
