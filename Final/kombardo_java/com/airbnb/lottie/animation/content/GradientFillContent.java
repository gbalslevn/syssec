...
public class GradientFillContent implements DrawingContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    private RadialGradient getRadialGradient() {
        ...
        RadialGradient radialGradient2 = new RadialGradient(f5, f6, hypot, applyDynamicColorsIfNeeded, positions, Shader.TileMode.CLAMP);
    ...
    public void draw(Canvas canvas, Matrix matrix, int i5) {
        ...
        this.paint.setAlpha(MiscUtils.clamp((int) ((((i5 / 255.0f) * this.opacityAnimation.getValue().intValue()) / 100.0f) * 255.0f), 0, Function.USE_VARARGS));
