...
public class Keyframe<T> {
    ...
    public boolean containsProgress(float f5) {
        return f5 >= getStartProgress() && f5 < getEndProgress();
    }

    public Keyframe<T> copyWith(T t5, T t6) {
        return new Keyframe<>(t5, t6);
    }
    ...
    public Keyframe(LottieComposition lottieComposition, T t5, T t6, Interpolator interpolator, Interpolator interpolator2, float f5, Float f6) {
        this.startValueFloat = UNSET_FLOAT;
        this.endValueFloat = UNSET_FLOAT;
        this.startValueInt = UNSET_INT;
        this.endValueInt = UNSET_INT;
    ...
    public Keyframe(LottieComposition lottieComposition, T t5, T t6, Interpolator interpolator, Interpolator interpolator2, Interpolator interpolator3, float f5, Float f6) {
        this.startValueFloat = UNSET_FLOAT;
        this.endValueFloat = UNSET_FLOAT;
        this.startValueInt = UNSET_INT;
        this.endValueInt = UNSET_INT;
