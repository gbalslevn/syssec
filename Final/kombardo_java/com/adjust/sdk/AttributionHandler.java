...
public class AttributionHandler implements IAttributionHandler, IActivityPackageSender.ResponseDataCallbackSubscriber {
    ...
    public class c implements Runnable {
        ...
        public final /* synthetic */ SessionResponseData f4128a;

        public c(SessionResponseData sessionResponseData) {
            this.f4128a = sessionResponseData;
        }
        ...
        public final void run() {
            ...
            AttributionHandler.this.checkSessionResponseI(iActivityHandler, this.f4128a);
        }
    }
    ...
    public class d implements Runnable {
        ...
        /* renamed from: a, reason: collision with root package name */
        public final /* synthetic */ SdkClickResponseData f4130a;

        public d(SdkClickResponseData sdkClickResponseData) {
            this.f4130a = sdkClickResponseData;
        }
        ...
        public final void run() {
            ...
            AttributionHandler.this.checkSdkClickResponseI(iActivityHandler, this.f4130a);
        }
    }
    ...
    public class e implements Runnable {
        ...
        /* renamed from: a, reason: collision with root package name */
        public final /* synthetic */ AttributionResponseData f4132a;

        public e(AttributionResponseData attributionResponseData) {
            this.f4132a = attributionResponseData;
        }
        ...
        public final void run() {
            ...
            AttributionHandler.this.checkAttributionResponseI(iActivityHandler, this.f4132a);
        }
    }
    ...
    public class g implements Runnable {
        ...
        /* renamed from: a, reason: collision with root package name */
        public final /* synthetic */ ResponseData f4135a;

        public g(ResponseData responseData) {
            this.f4135a = responseData;
        }
        ...
        public final void run() {
            ...
            ResponseData responseData = this.f4135a;
    ...
    public AttributionHandler(IActivityHandler iActivityHandler, boolean z5, IActivityPackageSender iActivityPackageSender) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void getAttributionI(long j5) {
        if (this.timer.getFireIn() > j5) {
            return;
        }
        if (j5 != 0) {
            this.logger.debug("Waiting to query attribution in %s seconds", Util.SecondsDisplayFormat.format(j5 / 1000.0d));
        }
        this.timer.startIn(j5);
    }
