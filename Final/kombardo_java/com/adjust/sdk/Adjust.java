...
public class Adjust {
    ...
    public static void setEnabled(boolean z5) {
        getDefaultInstance().setEnabled(z5);
    }

    public static void setOfflineMode(boolean z5) {
        getDefaultInstance().setOfflineMode(z5);
    }
    ...
    public static void trackMeasurementConsent(boolean z5) {
        getDefaultInstance().trackMeasurementConsent(z5);
    }
