...
public class TimerCycle {
    ...
    public TimerCycle(Runnable runnable, long j5, long j6, String str) {
        ...
        this.logger.verbose("%s configured to fire after %s seconds of starting and cycles every %s seconds", str, decimalFormat.format(j5 / 1000.0d), decimalFormat.format(j6 / 1000.0d));
    }

    private void cancel(boolean z5) {
