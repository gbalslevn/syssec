...
public class TimerOnce {
    ...
    public void startIn(long j5) {
        cancel(false);
        this.logger.verbose("%s starting. Launching in %s seconds", this.name, Util.SecondsDisplayFormat.format(j5 / 1000.0d));
        this.waitingTask = this.scheduler.scheduleFuture(new a(), j5);
    }
