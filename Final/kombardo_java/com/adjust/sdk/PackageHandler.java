...
public class PackageHandler implements IPackageHandler, IActivityPackageSender.ResponseDataCallbackSubscriber {
    ...
    public class b implements Runnable {
        ...
        public final /* synthetic */ ActivityPackage f4154a;

        public b(ActivityPackage activityPackage) {
            this.f4154a = activityPackage;
        }

        @Override // java.lang.Runnable
        public final void run() {
            PackageHandler.this.addI(this.f4154a);
        }
    }
    ...
    public class f implements Runnable {
        ...
        /* renamed from: a, reason: collision with root package name */
        public final /* synthetic */ SessionParameters f4159a;

        public f(SessionParameters sessionParameters) {
            this.f4159a = sessionParameters;
        }

        @Override // java.lang.Runnable
        public final void run() {
            PackageHandler.this.updatePackagesI(this.f4159a);
        }
    }
    ...
    public PackageHandler(IActivityHandler iActivityHandler, Context context, boolean z5, IActivityPackageSender iActivityPackageSender) {
        init(iActivityHandler, context, z5, iActivityPackageSender);
    ...
    private void readPackageQueueI() {
        try {
            ...
            this.logger.error("Failed to read %s file (%s)", PACKAGE_QUEUE_NAME, e5.getMessage());
    ...
    @Override // com.adjust.sdk.IPackageHandler
    public void init(IActivityHandler iActivityHandler, Context context, boolean z5, IActivityPackageSender iActivityPackageSender) {
