...
public class SharedPreferencesManager {
    ...
    private SharedPreferencesManager(Context context) {
        try {
            ...
            AdjustFactory.getLogger().error("Cannot access to SharedPreferences", e5.getMessage());
            sharedPreferences = null;
            sharedPreferencesEditor = null;
        }
    }

    private synchronized boolean getBoolean(String str, boolean z5) {
        SharedPreferences sharedPreferences2 = sharedPreferences;
        if (sharedPreferences2 == null) {
            return z5;
        }
        try {
            return sharedPreferences2.getBoolean(str, z5);
    ...
    private synchronized long getLong(String str, long j5) {
        SharedPreferences sharedPreferences2 = sharedPreferences;
        if (sharedPreferences2 == null) {
            return j5;
        }
        try {
            return sharedPreferences2.getLong(str, j5);
        } catch (ClassCastException unused) {
            return j5;
        }
    }

    private synchronized int getRawReferrerIndex(String str, long j5) {
        try {
    ...
    private synchronized void saveBoolean(String str, boolean z5) {
        SharedPreferences.Editor editor = sharedPreferencesEditor;
        if (editor != null) {
            editor.putBoolean(str, z5).apply();
        }
    }

    private synchronized void saveInteger(String str, int i5) {
        SharedPreferences.Editor editor = sharedPreferencesEditor;
        if (editor != null) {
            editor.putInt(str, i5).apply();
        }
    }

    private synchronized void saveLong(String str, long j5) {
        SharedPreferences.Editor editor = sharedPreferencesEditor;
        if (editor != null) {
            editor.putLong(str, j5).apply();
        }
    }
    ...
    public synchronized JSONArray getRawReferrer(String str, long j5) {
        int rawReferrerIndex = getRawReferrerIndex(str, j5);
    ...
    public synchronized void removeRawReferrer(String str, long j5) {
        if (str != null) {
            if (str.length() != 0) {
                int rawReferrerIndex = getRawReferrerIndex(str, j5);
                if (rawReferrerIndex < 0) {
                ...
                for (int i5 = 0; i5 < rawReferrerArray.length(); i5++) {
                    if (i5 != rawReferrerIndex) {
                        try {
                            jSONArray.put(rawReferrerArray.getJSONArray(i5));
                        } catch (JSONException unused) {
                        }
                    }
                }
    ...
    public synchronized void saveDeeplink(Uri uri, long j5) {
        if (uri == null) {
            return;
        }
        saveString(PREFS_KEY_DEEPLINK_URL, uri.toString());
        saveLong(PREFS_KEY_DEEPLINK_CLICK_TIME, j5);
    }
    ...
    public synchronized void saveRawReferrer(String str, long j5) {
        if (getRawReferrer(str, j5) != null) {
            return;
        }
        JSONArray rawReferrerArray = getRawReferrerArray();
    ...
    public synchronized void setPreinstallPayloadReadStatus(long j5) {
        saveLong(PREFS_KEY_PREINSTALL_PAYLOAD_READ_STATUS, j5);
    }
