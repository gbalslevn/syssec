...
public class PackageFactory {
    ...
    */
    public static ActivityPackage buildDeeplinkSdkClickPackage(Uri uri, long j5, ActivityState activityState, AdjustConfig adjustConfig, a aVar, SessionParameters sessionParameters) {
        String uri2;
        ...
        try {
            ...
            AdjustFactory.getLogger().error("Deeplink url decoding failed due to UnsupportedEncodingException. Message: (%s)", e5.getMessage());
        } catch (IllegalArgumentException e6) {
            AdjustFactory.getLogger().error("Deeplink url decoding failed due to IllegalArgumentException. Message: (%s)", e6.getMessage());
        } catch (Exception e7) {
            AdjustFactory.getLogger().error("Deeplink url decoding failed. Message: (%s)", e7.getMessage());
        }
        ...
        queryStringClickPackageBuilder.clickTimeInMilliseconds = j5;
    ...
    public static ActivityPackage buildReftagSdkClickPackage(String str, long j5, ActivityState activityState, AdjustConfig adjustConfig, a aVar, SessionParameters sessionParameters) {
        ...
        try {
            ...
            AdjustFactory.getLogger().error("Referrer decoding failed due to UnsupportedEncodingException. Message: (%s)", e5.getMessage());
        } catch (IllegalArgumentException e6) {
            AdjustFactory.getLogger().error("Referrer decoding failed due to IllegalArgumentException. Message: (%s)", e6.getMessage());
        } catch (Exception e7) {
            AdjustFactory.getLogger().error("Referrer decoding failed. Message: (%s)", e7.getMessage());
        }
