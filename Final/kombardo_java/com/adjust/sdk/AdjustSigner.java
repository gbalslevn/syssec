...
public class AdjustSigner {
    ...
    public static void disableSigning(ILogger iLogger) {
        ...
        try {
            ...
            iLogger.warn("Invoking Signer disableSigning() received an error [%s]", e5.getMessage());
        }
    }
    ...
    public static void enableSigning(ILogger iLogger) {
        ...
        try {
            ...
            iLogger.warn("Invoking Signer enableSigning() received an error [%s]", e5.getMessage());
        }
    }
    ...
    public static void onResume(ILogger iLogger) {
        ...
        try {
            ...
            iLogger.warn("Invoking Signer onResume() received an error [%s]", e5.getMessage());
        }
    }
    ...
    public static void sign(Map<String, String> map, String str, String str2, Context context, ILogger iLogger) {
        ...
        try {
            ...
            iLogger.warn("Invoking Signer sign() for %s received an error [%s]", str, e5.getMessage());
        }
    }
}
