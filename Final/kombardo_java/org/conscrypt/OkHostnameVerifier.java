...
public final class OkHostnameVerifier implements ConscryptHostnameVerifier {
    ...
    private OkHostnameVerifier(boolean z5) {
        this.strictWildcardMode = z5;
    }
    ...
    private static List<String> getSubjectAltNames(X509Certificate x509Certificate, int i5) {
        Integer num;
        String str;
    ...
    private boolean verifyHostName(String str, X509Certificate x509Certificate) {
        ...
        for (int i5 = 0; i5 < size; i5++) {
            if (verifyHostName(lowerCase, subjectAltNames.get(i5))) {
                return true;
            }
        }
        return false;
    ...
    private boolean verifyIpAddress(String str, X509Certificate x509Certificate) {
        ...
        int size = subjectAltNames.size();
        for (int i5 = 0; i5 < size; i5++) {
            if (str.equalsIgnoreCase(subjectAltNames.get(i5))) {
                return true;
            }
        }
        return false;
