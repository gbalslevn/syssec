...
final class DuckTypedPSKKeyManager implements PSKKeyManager {
    ...
    public String chooseClientKeyIdentity(String str, Socket socket) {
        try {
            ...
            throw new RuntimeException("Failed to invoke chooseClientKeyIdentity", e5);
        }
    }
    ...
    public String chooseServerKeyIdentityHint(Socket socket) {
        try {
            ...
            throw new RuntimeException("Failed to invoke chooseServerKeyIdentityHint", e5);
        }
    }
    ...
    public SecretKey getKey(String str, String str2, Socket socket) {
        try {
            ...
            throw new RuntimeException("Failed to invoke getKey", e5);
        }
    }
