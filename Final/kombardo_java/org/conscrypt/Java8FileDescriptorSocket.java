...
public final class Java8FileDescriptorSocket extends ConscryptFileDescriptorSocket {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public Java8FileDescriptorSocket(String str, int i5, SSLParametersImpl sSLParametersImpl) {
        super(str, i5, sSLParametersImpl);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public Java8FileDescriptorSocket(InetAddress inetAddress, int i5, SSLParametersImpl sSLParametersImpl) {
        super(inetAddress, i5, sSLParametersImpl);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public Java8FileDescriptorSocket(String str, int i5, InetAddress inetAddress, int i6, SSLParametersImpl sSLParametersImpl) {
        super(str, i5, inetAddress, i6, sSLParametersImpl);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public Java8FileDescriptorSocket(InetAddress inetAddress, int i5, InetAddress inetAddress2, int i6, SSLParametersImpl sSLParametersImpl) {
        super(inetAddress, i5, inetAddress2, i6, sSLParametersImpl);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public Java8FileDescriptorSocket(Socket socket, String str, int i5, boolean z5, SSLParametersImpl sSLParametersImpl) {
