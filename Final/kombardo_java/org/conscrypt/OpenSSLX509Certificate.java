...
public final class OpenSSLX509Certificate extends X509Certificate {
    ...
    public OpenSSLX509Certificate(long j5) {
        this.mContext = j5;
        this.notBefore = toDate(NativeCrypto.X509_get_notBefore(j5, this));
        this.notAfter = toDate(NativeCrypto.X509_get_notAfter(j5, this));
    }
        ...
        try {
            try {
                ...
                for (long j5 : d2i_PKCS7_bio) {
                    if (j5 != 0) {
                        arrayList.add(new OpenSSLX509Certificate(j5));
                    }
                }
                return arrayList;
            } catch (Exception e5) {
    ...
    private static Date toDate(long j5) {
    ...
    protected void finalize() {
        try {
            ...
            if (j5 != 0) {
                NativeCrypto.X509_free(j5, this);
            }
        } finally {
            super.finalize();
        }
    ...
    public int getBasicConstraints() {
        ...
        int i5 = NativeCrypto.get_X509_ex_pathlen(this.mContext, this);
        if (i5 == -1) {
    ...
    private OpenSSLX509Certificate(long j5, Date date, Date date2) {
        this.mContext = j5;
        this.notBefore = date;
        this.notAfter = date2;
    }
