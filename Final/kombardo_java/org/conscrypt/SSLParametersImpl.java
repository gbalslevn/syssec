...
public final class SSLParametersImpl implements Cloneable {
    ...
    void setCTVerificationEnabled(boolean z5) {
        this.ctVerificationEnabled = z5;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void setEnableSessionCreation(boolean z5) {
        this.enable_session_creation = z5;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void setUseCipherSuitesOrder(boolean z5) {
        this.useCipherSuitesOrder = z5;
    }
    ...
    public void setUseSessionTickets(boolean z5) {
        this.useSessionTickets = z5;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void setUseSni(boolean z5) {
        this.useSni = Boolean.valueOf(z5);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void setWantClientAuth(boolean z5) {
        this.want_client_auth = z5;
        this.need_client_auth = false;
    }
