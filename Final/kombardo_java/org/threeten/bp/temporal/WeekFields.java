...
public final class WeekFields implements Serializable {
    ...
    static class ComputedDayOfField implements TemporalField {
        ...
        private int computeWeek(int i5, int i6) {
            return ((i5 + 7) + (i6 - 1)) / 7;
        }

        private int localizedDayOfWeek(TemporalAccessor temporalAccessor, int i5) {
            return Jdk8Methods.floorMod(temporalAccessor.get(ChronoField.DAY_OF_WEEK) - i5, 7) + 1;
        }
        ...
        private int localizedWBY(TemporalAccessor temporalAccessor) {
            ...
            return localizedWeekOfYear >= ((long) computeWeek(startOfWeekOffset(temporalAccessor.get(ChronoField.DAY_OF_YEAR), floorMod), (Year.isLeap((long) i5) ? 366 : 365) + this.weekDef.getMinimalDaysInFirstWeek())) ? i5 + 1 : i5;
        }
        ...
        private long localizedWeekOfMonth(TemporalAccessor temporalAccessor, int i5) {
            int i6 = temporalAccessor.get(ChronoField.DAY_OF_MONTH);
            return computeWeek(startOfWeekOffset(i6, i5), i6);
        }

        private long localizedWeekOfYear(TemporalAccessor temporalAccessor, int i5) {
        ...
        private int startOfWeekOffset(int i5, int i6) {
            int floorMod = Jdk8Methods.floorMod(i5 - i6, 7);
        ...
        public <R extends Temporal> R adjustInto(R r5, long j5) {
            int checkValidIntValue = this.range.checkValidIntValue(j5, this);
            if (checkValidIntValue == r5.get(this)) {
                return r5;
            }
            if (this.rangeUnit != ChronoUnit.FOREVER) {
                return (R) r5.plus(checkValidIntValue - r1, this.baseUnit);
            }
            int i5 = r5.get(this.weekDef.weekOfWeekBasedYear);
            long j6 = (long) ((j5 - r1) * 52.1775d);
            ChronoUnit chronoUnit = ChronoUnit.WEEKS;
            Temporal plus = r5.plus(j6, chronoUnit);
            ...
            R r6 = (R) plus.plus(i5 - plus.get(this.weekDef.weekOfWeekBasedYear), chronoUnit);
            return r6.get(this) > checkValidIntValue ? (R) r6.minus(1L, chronoUnit) : r6;
        }
        ...
        public long getFrom(TemporalAccessor temporalAccessor) {
            ...
            if (temporalUnit == ChronoUnit.MONTHS) {
                ...
                localizedWBY = computeWeek(startOfWeekOffset(i5, floorMod), i5);
            } else if (temporalUnit == ChronoUnit.YEARS) {
                int i6 = temporalAccessor.get(ChronoField.DAY_OF_YEAR);
                localizedWBY = computeWeek(startOfWeekOffset(i6, floorMod), i6);
        ...
        public TemporalAccessor resolve(Map<TemporalField, Long> map, TemporalAccessor temporalAccessor, ResolverStyle resolverStyle) {
            ...
            if (temporalUnit != chronoUnit) {
                ...
                ChronoLocalDate plus2 = date3.plus((checkValidIntValue * j5) + (floorMod2 - localizedDayOfWeek), (TemporalUnit) ChronoUnit.DAYS);
