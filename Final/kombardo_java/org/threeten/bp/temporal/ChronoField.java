...
public final class ChronoField implements TemporalField {
    ...
    private ChronoField(String str, int i5, String str2, TemporalUnit temporalUnit, TemporalUnit temporalUnit2, ValueRange valueRange) {
        this.name = str2;
    ...
    public <R extends Temporal> R adjustInto(R r5, long j5) {
        return (R) r5.with(this, j5);
    }

    public int checkValidIntValue(long j5) {
        return range().checkValidIntValue(j5, this);
    }

    public long checkValidValue(long j5) {
        return range().checkValidValue(j5, this);
    }
