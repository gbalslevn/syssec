...
public final class IsoChronology extends Chronology implements Serializable {
    ...
    public LocalDate resolveDate(Map<TemporalField, Long> map, ResolverStyle resolverStyle) {
        ...
        if (remove2 != null) {
            ...
            if (remove3 == null) {
                ...
                Long l5 = map.get(chronoField4);
                if (resolverStyle != ResolverStyle.STRICT) {
                    updateResolveMap(map, chronoField4, (l5 == null || l5.longValue() > 0) ? remove2.longValue() : Jdk8Methods.safeSubtract(1L, remove2.longValue()));
                } else if (l5 != null) {
                    updateResolveMap(map, chronoField4, l5.longValue() > 0 ? remove2.longValue() : Jdk8Methods.safeSubtract(1L, remove2.longValue()));
                } else {
    ...
    @Override // org.threeten.bp.chrono.Chronology
    public LocalDate date(int i5, int i6, int i7) {
