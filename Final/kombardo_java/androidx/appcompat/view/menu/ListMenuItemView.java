...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
    ...
    public void setCheckable(boolean z5) {
        ...
        View view;
        if (!z5 && this.mRadioButton == null && this.mCheckBox == null) {
            return;
        }
    ...
    public void setForceShowIcon(boolean z5) {
        ...
        this.mPreserveIconSpacing = z5;
    }

    public void setGroupDividerEnabled(boolean z5) {
        ImageView imageView = this.mGroupDivider;
        if (imageView != null) {
            imageView.setVisibility((this.mHasListDivider || !z5) ? 8 : 0);
        }
    }

    public void setIcon(Drawable drawable) {
        boolean z5 = this.mItemData.shouldShowIcon() || this.mForceShowIcon;
        if (z5 || this.mPreserveIconSpacing) {
    ...
    public void setShortcut(boolean z5, char c5) {
        int i5 = (z5 && this.mItemData.shouldShowShortcut()) ? 0 : 8;
        if (i5 == 0) {
