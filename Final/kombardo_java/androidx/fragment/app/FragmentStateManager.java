...
public class FragmentStateManager {
    ...
    void destroy() {
        ...
        if (fragmentHostCallback instanceof ViewModelStoreOwner) {
            z5 = this.mFragmentStore.getNonConfig().isCleared();
        } else if (fragmentHostCallback.getContext() instanceof Activity) {
            z5 = true ^ ((Activity) fragmentHostCallback.getContext()).isChangingConfigurations();
        }
        if ((z6 && !this.mFragment.mBeingSaved) || z5) {
        ...
        try {
            ...
            while (true) {
                ...
                if (computeExpectedState == i5) {
                    if (!z5 && i5 == -1 && fragment.mRemoving && !fragment.isInBackStack() && !this.mFragment.mBeingSaved) {
                        if (FragmentManager.isLoggingEnabled(3)) {
    ...
    public void saveState() {
        ...
        if (fragment.mState <= -1 || fragmentState.mSavedFragmentState != null) {
            ...
            if (this.mFragment.mTargetWho != null) {
                ...
                if (i5 != 0) {
                    fragmentState.mSavedFragmentState.putInt(TARGET_REQUEST_CODE_STATE_TAG, i5);
                }
            }
        }
