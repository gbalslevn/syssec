...
public class FragmentLifecycleCallbacksDispatcher {
    ...
    public static final class FragmentLifecycleCallbacksHolder {
        ...
        FragmentLifecycleCallbacksHolder(FragmentManager.FragmentLifecycleCallbacks fragmentLifecycleCallbacks, boolean z5) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentActivityCreated(Fragment fragment, Bundle bundle, boolean z5) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentAttached(Fragment fragment, boolean z5) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentCreated(Fragment fragment, Bundle bundle, boolean z5) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentDestroyed(Fragment fragment, boolean z5) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentDetached(Fragment fragment, boolean z5) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentPaused(Fragment fragment, boolean z5) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentPreAttached(Fragment fragment, boolean z5) {
        Context context = this.mFragmentManager.getHost().getContext();
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentPreCreated(Fragment fragment, Bundle bundle, boolean z5) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentResumed(Fragment fragment, boolean z5) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentSaveInstanceState(Fragment fragment, Bundle bundle, boolean z5) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentStarted(Fragment fragment, boolean z5) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentStopped(Fragment fragment, boolean z5) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentViewCreated(Fragment fragment, View view, Bundle bundle, boolean z5) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentViewDestroyed(Fragment fragment, boolean z5) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void registerFragmentLifecycleCallbacks(FragmentManager.FragmentLifecycleCallbacks fragmentLifecycleCallbacks, boolean z5) {
        this.mLifecycleCallbacks.add(new FragmentLifecycleCallbacksHolder(fragmentLifecycleCallbacks, z5));
    }
