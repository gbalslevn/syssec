...
abstract class TypefaceCompatApi21Impl extends TypefaceCompatBaseImpl {
    ...
    private static boolean addFontWeightStyle(Object obj, String str, int i5, boolean z5) {
        init();
        try {
            return ((Boolean) sAddFontWeightStyle.invoke(obj, str, Integer.valueOf(i5), Boolean.valueOf(z5))).booleanValue();
