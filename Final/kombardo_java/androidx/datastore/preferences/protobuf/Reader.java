...
interface Reader {
    ...
    <T> void mergeGroupField(T t5, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite);

    <T> void mergeMessageField(T t5, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite);
