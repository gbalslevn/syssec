...
public final class SimpleActor<T> {
        ...
        if (job != null) {
            job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
                ...
                public final void invoke2(Throwable th) {
                    ...
                    do {
                        Object m3772getOrNullimpl = ChannelResult.m3772getOrNullimpl(((SimpleActor) this).messageQueue.mo3766tryReceivePtdJZtk());
                        if (m3772getOrNullimpl != null) {
                            onUndeliveredElement.invoke(m3772getOrNullimpl, th);
                            unit = Unit.INSTANCE;
                        } else {
                            unit = null;
                        }
    ...
    public final void offer(T msg) {
        Object mo3767trySendJP2dKIU = this.messageQueue.mo3767trySendJP2dKIU(msg);
        if (mo3767trySendJP2dKIU instanceof ChannelResult.Closed) {
            Throwable m3771exceptionOrNullimpl = ChannelResult.m3771exceptionOrNullimpl(mo3767trySendJP2dKIU);
            if (m3771exceptionOrNullimpl != null) {
                throw m3771exceptionOrNullimpl;
            }
            throw new ClosedSendChannelException("Channel was closed normally");
        }
        if (!ChannelResult.m3775isSuccessimpl(mo3767trySendJP2dKIU)) {
