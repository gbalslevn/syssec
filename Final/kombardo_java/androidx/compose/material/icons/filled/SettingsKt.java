...
public abstract class SettingsKt {
    ...
    public static final ImageVector getSettings(Icons.Filled filled) {
        ImageVector.Builder m1758addPathoIyEayM;
        ImageVector imageVector = _settings;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Settings", Dp.m2599constructorimpl(24.0f), Dp.m2599constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m1496getBlack0d7_KjU(), null);
        int m1607getButtKaPHkGw = StrokeCap.INSTANCE.m1607getButtKaPHkGw();
        int m1614getBevelLxFBmk8 = StrokeJoin.INSTANCE.m1614getBevelLxFBmk8();
        ...
        pathBuilder.close();
        m1758addPathoIyEayM = builder.m1758addPathoIyEayM(pathBuilder.getNodes(), (r30 & 2) != 0 ? VectorKt.getDefaultFillType() : defaultFillType, (r30 & 4) != 0 ? BuildConfig.FLAVOR : BuildConfig.FLAVOR, (r30 & 8) != 0 ? null : solidColor, (r30 & 16) != 0 ? 1.0f : 1.0f, (r30 & 32) == 0 ? null : null, (r30 & 64) != 0 ? 1.0f : 1.0f, (r30 & 128) != 0 ? 0.0f : 1.0f, (r30 & 256) != 0 ? VectorKt.getDefaultStrokeLineCap() : m1607getButtKaPHkGw, (r30 & 512) != 0 ? VectorKt.getDefaultStrokeLineJoin() : m1614getBevelLxFBmk8, (r30 & 1024) != 0 ? 4.0f : 1.0f, (r30 & 2048) != 0 ? 0.0f : 0.0f, (r30 & 4096) == 0 ? 0.0f : 1.0f, (r30 & 8192) == 0 ? 0.0f : 0.0f);
        ImageVector build = m1758addPathoIyEayM.build();
        _settings = build;
