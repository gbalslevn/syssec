...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000b\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u00020\u00040\u0003H\u008a@"}, d2 = {"<anonymous>", BuildConfig.FLAVOR, "T", "Landroidx/compose/runtime/ProduceStateScope;", BuildConfig.FLAVOR}, k = 3, mv = {1, 8, 0}, xi = 48)
            ...
            FlowCollector flowCollector = new FlowCollector() { // from class: androidx.compose.animation.AnimatedVisibilityKt$AnimatedEnterExitImpl$shouldDisposeAfterExit$2$1.2
                ...
                public final Object emit(boolean z5, Continuation<? super Unit> continuation) {
                    ...
                    if (z5) {
                        ...
                        z6 = ((Boolean) AnimatedEnterExitImpl$lambda$2.invoke(transition2.getCurrentState(), transition2.getTargetState())).booleanValue();
                    } else {
                        z6 = false;
                    }
                    produceStateScope2.setValue(Boxing.boxBoolean(z6));
