...
public final class InfiniteTransition$run$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Metadata(d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0007\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\u008a@"}, d2 = {"<anonymous>", BuildConfig.FLAVOR, "it", BuildConfig.FLAVOR}, k = 3, mv = {1, 8, 0}, xi = 48)
    ...
    public static final class AnonymousClass3 extends SuspendLambda implements Function2<Float, Continuation<? super Boolean>, Object> {
        ...
        public final Object invoke(float f5, Continuation<? super Boolean> continuation) {
            return ((AnonymousClass3) create(Float.valueOf(f5), continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public /* bridge */ /* synthetic */ Object invoke(Float f5, Continuation<? super Boolean> continuation) {
