...
public abstract /* synthetic */ class SnapshotStateKt__SnapshotFlowKt {
    public static final <T> State<T> collectAsState(StateFlow<? extends T> stateFlow, CoroutineContext coroutineContext, Composer composer, int i5, int i6) {
        ...
        State<T> collectAsState = SnapshotStateKt.collectAsState(stateFlow, stateFlow.getValue(), coroutineContext2, composer, (i5 & 14) | ((i5 << 3) & 896), 0);
        if (ComposerKt.isTraceInProgress()) {
        ...
        while (true) {
            ...
            if ((((~j5) << 7) & j5 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i7 = 0; i7 < i6; i7++) {
                    if ((255 & j5) < 128 && set.contains(objArr[(i5 << 3) + i7])) {
                        return true;
                    }
                    j5 >>= 8;
                }
    ...
    public static final <T extends R, R> State<R> collectAsState(Flow<? extends T> flow, R r5, CoroutineContext coroutineContext, Composer composer, int i5, int i6) {
        ...
        State<R> produceState = SnapshotStateKt.produceState(r5, flow, coroutineContext2, (Function2) rememberedValue, composer, ((i5 >> 3) & 14) | ((i5 << 3) & 112) | (i5 & 896));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        return produceState;
