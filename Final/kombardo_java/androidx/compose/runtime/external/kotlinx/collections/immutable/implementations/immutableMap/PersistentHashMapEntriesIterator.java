    ...
    */
    public PersistentHashMapEntriesIterator(TrieNode<K, V> trieNode) {
        ...
        for (int i5 = 0; i5 < 8; i5++) {
            trieNodeBaseIteratorArr[i5] = new TrieNodeEntriesIterator();
        }
    }
}
