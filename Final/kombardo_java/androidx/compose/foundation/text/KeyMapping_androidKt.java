...
public abstract class KeyMapping_androidKt {
    private static final KeyMapping platformDefaultKeyMapping = new KeyMapping() { // from class: androidx.compose.foundation.text.KeyMapping_androidKt$platformDefaultKeyMapping$1
        ...
        public KeyCommand mo479mapZmokQxo(KeyEvent event) {
            KeyCommand keyCommand = null;
            if (KeyEvent_androidKt.m1831isShiftPressedZmokQxo(event) && KeyEvent_androidKt.m1829isAltPressedZmokQxo(event)) {
            ...
            return keyCommand == null ? KeyMappingKt.getDefaultKeyMapping().mo479mapZmokQxo(event) : keyCommand;
        }
    };
