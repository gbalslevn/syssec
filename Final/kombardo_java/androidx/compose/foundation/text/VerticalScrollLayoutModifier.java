...
final /* data */ class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo21measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j5) {
        final Placeable mo1946measureBRTryo0 = measurable.mo1946measureBRTryo0(Constraints.m2570copyZbe2FdA$default(j5, 0, 0, 0, Integer.MAX_VALUE, 7, null));
        final int min = Math.min(mo1946measureBRTryo0.getHeight(), Constraints.m2577getMaxHeightimpl(j5));
        return MeasureScope.layout$default(measureScope, mo1946measureBRTryo0.getWidth(), min, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.VerticalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                this.getScrollerPosition().update(Orientation.Vertical, TextFieldScrollKt.access$getCursorRectInScroller(measureScope2, cursorOffset, transformedText, invoke != null ? invoke.getValue() : null, false, mo1946measureBRTryo0.getWidth()), min, mo1946measureBRTryo0.getHeight());
                Placeable.PlacementScope.placeRelative$default(placementScope, mo1946measureBRTryo0, 0, Math.round(-this.getScrollerPosition().getOffset()), 0.0f, 4, null);
            }
        }, 4, null);
    }
