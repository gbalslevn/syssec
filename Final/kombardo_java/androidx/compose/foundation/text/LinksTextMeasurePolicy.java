...
final class LinksTextMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo19measure3p2s80s(MeasureScope measureScope, final List<? extends Measurable> list, long j5) {
        return MeasureScope.layout$default(measureScope, Constraints.m2578getMaxWidthimpl(j5), Constraints.m2577getMaxHeightimpl(j5), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.LinksTextMeasurePolicy$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                List access$measureWithTextRangeMeasureConstraints = BasicTextKt.access$measureWithTextRangeMeasureConstraints(list2, function0);
                if (access$measureWithTextRangeMeasureConstraints != null) {
                    ...
                    for (int i5 = 0; i5 < size; i5++) {
                        ...
                        Placeable.PlacementScope.m1968place70tqf50$default(placementScope, placeable, function02 != null ? ((IntOffset) function02.invoke()).getPackedValue() : IntOffset.INSTANCE.m2648getZeronOccac(), 0.0f, 2, null);
                    }
                }
            }
        }, 4, null);
