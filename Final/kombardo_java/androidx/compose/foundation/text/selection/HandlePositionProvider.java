...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    private long prevPosition = Offset.INSTANCE.m1349getZeroF1C5BW0();
    ...
    public long mo155calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        long mo474provideF1C5BW0 = this.positionProvider.mo474provideF1C5BW0();
        if (!OffsetKt.m1351isSpecifiedk4lQ0M(mo474provideF1C5BW0)) {
            mo474provideF1C5BW0 = this.prevPosition;
        }
        this.prevPosition = mo474provideF1C5BW0;
        return IntOffset.m2644plusqkQi6aY(IntOffset.m2644plusqkQi6aY(anchorBounds.m2654getTopLeftnOccac(), IntOffsetKt.m2651roundk4lQ0M(mo474provideF1C5BW0)), this.handleReferencePoint.mo1251alignKFBX0sM(popupContentSize, IntSize.INSTANCE.m2665getZeroYbymL2g(), layoutDirection));
    }
}
