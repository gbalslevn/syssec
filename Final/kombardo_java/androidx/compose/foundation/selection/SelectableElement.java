...
final class SelectableElement extends ModifierNodeElement<SelectableNode> {
    ...
    public /* synthetic */ SelectableElement(boolean z5, MutableInteractionSource mutableInteractionSource, IndicationNodeFactory indicationNodeFactory, boolean z6, Role role, Function0 function0, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    private SelectableElement(boolean z5, MutableInteractionSource mutableInteractionSource, IndicationNodeFactory indicationNodeFactory, boolean z6, Role role, Function0<Unit> function0) {
        this.selected = z5;
    ...
    public void update(SelectableNode node) {
        node.m452updateQzZPfjk(this.selected, this.interactionSource, this.indicationNodeFactory, this.enabled, this.role, this.onClick);
    }
}
