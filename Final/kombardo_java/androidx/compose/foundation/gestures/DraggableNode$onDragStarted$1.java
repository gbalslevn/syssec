...
final class DraggableNode$onDragStarted$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public DraggableNode$onDragStarted$1(DraggableNode draggableNode, long j5, Continuation<? super DraggableNode$onDragStarted$1> continuation) {
        super(2, continuation);
        this.this$0 = draggableNode;
        this.$startedPosition = j5;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            Offset m1328boximpl = Offset.m1328boximpl(this.$startedPosition);
            this.label = 1;
            if (function3.invoke(coroutineScope, m1328boximpl, this) == coroutine_suspended) {
