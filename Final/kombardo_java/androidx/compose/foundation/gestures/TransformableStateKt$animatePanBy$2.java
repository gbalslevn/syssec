...
final class TransformableStateKt$animatePanBy$2 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
    ...
    public TransformableStateKt$animatePanBy$2(Ref$LongRef ref$LongRef, long j5, AnimationSpec<Offset> animationSpec, Continuation<? super TransformableStateKt$animatePanBy$2> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            AnimationState animationState = new AnimationState(VectorConvertersKt.getVectorConverter(Offset.INSTANCE), Offset.m1328boximpl(this.$previous.element), null, 0L, 0L, false, 60, null);
            Offset m1328boximpl = Offset.m1328boximpl(this.$offset);
            ...
            Function1<AnimationScope<Offset, AnimationVector2D>, Unit> function1 = new Function1<AnimationScope<Offset, AnimationVector2D>, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt$animatePanBy$2.1
                ...
                public final void invoke2(AnimationScope<Offset, AnimationVector2D> animationScope) {
                    TransformScope.m245transformByd4ec7I$default(transformScope, 0.0f, Offset.m1341minusMKHz9U(animationScope.getValue().getPackedValue(), Ref$LongRef.this.element), 0.0f, 5, null);
                    Ref$LongRef.this.element = animationScope.getValue().getPackedValue();
                }
            };
            this.label = 1;
            if (SuspendAnimationKt.animateTo$default(animationState, m1328boximpl, animationSpec, false, function1, this, 4, null) == coroutine_suspended) {
