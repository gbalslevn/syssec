...
public final class PlatformMagnifierFactoryApi28Impl implements PlatformMagnifierFactory {
    ...
    public static class PlatformMagnifierImpl implements PlatformMagnifier {
        ...
        public long mo146getSizeYbymL2g() {
        ...
        public void mo147updateWko1d7g(long sourceCenter, long magnifierCenter, float zoom) {
            this.magnifier.show(Offset.m1337getXimpl(sourceCenter), Offset.m1338getYimpl(sourceCenter));
        }
