...
public final class PagerBeyondBoundsState implements LazyLayoutBeyondBoundsState {
    ...
    public PagerBeyondBoundsState(PagerState pagerState, int i5) {
        this.state = pagerState;
        this.beyondViewportPageCount = i5;
    }
