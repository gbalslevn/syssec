...
public abstract class ClipScrollableContainerKt {
    ...
    private static final float MaxSupportedElevation = Dp.m2599constructorimpl(30);
    ...
    static {
        ...
        HorizontalScrollableClipModifier = ClipKt.clip(companion, new Shape() { // from class: androidx.compose.foundation.ClipScrollableContainerKt$HorizontalScrollableClipModifier$1
            ...
            public Outline mo131createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
                float mo206roundToPx0680j_4 = density.mo206roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
                return new Outline.Rectangle(new Rect(0.0f, -mo206roundToPx0680j_4, Size.m1377getWidthimpl(size), Size.m1375getHeightimpl(size) + mo206roundToPx0680j_4));
            }
        });
        VerticalScrollableClipModifier = ClipKt.clip(companion, new Shape() { // from class: androidx.compose.foundation.ClipScrollableContainerKt$VerticalScrollableClipModifier$1
            ...
            public Outline mo131createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
                float mo206roundToPx0680j_4 = density.mo206roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
                return new Outline.Rectangle(new Rect(-mo206roundToPx0680j_4, 0.0f, Size.m1377getWidthimpl(size) + mo206roundToPx0680j_4, Size.m1375getHeightimpl(size)));
            }
        });
    }
