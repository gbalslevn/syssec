...
abstract class IntrinsicSizeModifier extends Modifier.Node implements LayoutModifierNode {
    ...
    public final MeasureResult mo46measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j5) {
        long mo293calculateContentConstraintsl58MMJ0 = mo293calculateContentConstraintsl58MMJ0(measureScope, measurable, j5);
        if (getEnforceIncoming()) {
            mo293calculateContentConstraintsl58MMJ0 = ConstraintsKt.m2591constrainN9IONVI(j5, mo293calculateContentConstraintsl58MMJ0);
        }
        final Placeable mo1946measureBRTryo0 = measurable.mo1946measureBRTryo0(mo293calculateContentConstraintsl58MMJ0);
        return MeasureScope.layout$default(measureScope, mo1946measureBRTryo0.getWidth(), mo1946measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.IntrinsicSizeModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m1969placeRelative70tqf50$default(placementScope, Placeable.this, IntOffset.INSTANCE.m2648getZeronOccac(), 0.0f, 2, null);
            }
        }, 4, null);
    }
