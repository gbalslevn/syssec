...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo19measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j5) {
        return MeasureScope.layout$default(measureScope, Constraints.m2576getHasFixedWidthimpl(j5) ? Constraints.m2578getMaxWidthimpl(j5) : 0, Constraints.m2575getHasFixedHeightimpl(j5) ? Constraints.m2577getMaxHeightimpl(j5) : 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$measure$1$1
