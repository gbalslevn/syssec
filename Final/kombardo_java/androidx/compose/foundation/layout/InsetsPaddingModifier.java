...
public final class InsetsPaddingModifier implements LayoutModifier, ModifierLocalConsumer, ModifierLocalProvider<WindowInsets> {
    ...
    public MeasureResult mo21measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j5) {
        ...
        final Placeable mo1946measureBRTryo0 = measurable.mo1946measureBRTryo0(ConstraintsKt.m2595offsetNN6EwU(j5, -right, -bottom));
        return MeasureScope.layout$default(measureScope, ConstraintsKt.m2593constrainWidthK40F9xA(j5, mo1946measureBRTryo0.getWidth() + right), ConstraintsKt.m2592constrainHeightK40F9xA(j5, mo1946measureBRTryo0.getHeight() + bottom), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.InsetsPaddingModifier$measure$1
