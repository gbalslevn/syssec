...
public abstract class TypographyKt {
    ...
    public static final TextStyle getValue(TypographyKeyTokens typographyKeyTokens, Composer composer, int i5) {
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1049072145, i5, -1, "androidx.compose.material3.<get-value> (Typography.kt:209)");
        }
