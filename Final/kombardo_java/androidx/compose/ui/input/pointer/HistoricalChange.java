...
public final class HistoricalChange {
    ...
    public String toString() {
        return "HistoricalChange(uptimeMillis=" + this.uptimeMillis + ", position=" + ((Object) Offset.m1344toStringimpl(this.position)) + ')';
    }
