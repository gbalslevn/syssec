...
public final class TextAndroidCanvas extends Canvas {
    ...
    @Override // android.graphics.Canvas
    public void drawARGB(int a5, int r5, int g5, int b5) {
        Canvas canvas = this.nativeCanvas;
        if (canvas == null) {
            Intrinsics.throwUninitializedPropertyAccessException("nativeCanvas");
            canvas = null;
        }
        canvas.drawARGB(a5, r5, g5, b5);
    }
    ...
    @Override // android.graphics.Canvas
    public void drawPoint(float x5, float y5, Paint paint) {
        Canvas canvas = this.nativeCanvas;
        if (canvas == null) {
            Intrinsics.throwUninitializedPropertyAccessException("nativeCanvas");
            canvas = null;
        }
        canvas.drawPoint(x5, y5, paint);
    }
    ...
    @Override // android.graphics.Canvas
    public void drawRGB(int r5, int g5, int b5) {
        Canvas canvas = this.nativeCanvas;
        if (canvas == null) {
            Intrinsics.throwUninitializedPropertyAccessException("nativeCanvas");
            canvas = null;
        }
        canvas.drawRGB(r5, g5, b5);
    }
    ...
    @Override // android.graphics.Canvas
    public void drawText(char[] text, int index, int count, float x5, float y5, Paint paint) {
        Canvas canvas = this.nativeCanvas;
        if (canvas == null) {
            Intrinsics.throwUninitializedPropertyAccessException("nativeCanvas");
            canvas = null;
        }
        canvas.drawText(text, index, count, x5, y5, paint);
    }
    ...
    @Override // android.graphics.Canvas
    public void drawTextRun(char[] text, int index, int count, int contextIndex, int contextCount, float x5, float y5, boolean isRtl, Paint paint) {
        ...
        canvasCompatM.drawTextRun(canvas, text, index, count, contextIndex, contextCount, x5, y5, isRtl, paint);
    }
    ...
    @Override // android.graphics.Canvas
    public void drawRect(Rect r5, Paint paint) {
        Canvas canvas = this.nativeCanvas;
        if (canvas == null) {
            Intrinsics.throwUninitializedPropertyAccessException("nativeCanvas");
            canvas = null;
    ...
    @Override // android.graphics.Canvas
    public void drawText(String text, float x5, float y5, Paint paint) {
        Canvas canvas = this.nativeCanvas;
        if (canvas == null) {
            Intrinsics.throwUninitializedPropertyAccessException("nativeCanvas");
            canvas = null;
    ...
    @Override // android.graphics.Canvas
    public void drawText(String text, int start, int end, float x5, float y5, Paint paint) {
        Canvas canvas = this.nativeCanvas;
        if (canvas == null) {
            Intrinsics.throwUninitializedPropertyAccessException("nativeCanvas");
            canvas = null;
    ...
    @Override // android.graphics.Canvas
    @Deprecated
    public void drawBitmap(int[] colors, int offset, int stride, float x5, float y5, int width, int height, boolean hasAlpha, Paint paint) {
        Canvas canvas = this.nativeCanvas;
        if (canvas == null) {
            Intrinsics.throwUninitializedPropertyAccessException("nativeCanvas");
            canvas = null;
        }
        canvas.drawBitmap(colors, offset, stride, x5, y5, width, height, hasAlpha, paint);
    }
    ...
    @Override // android.graphics.Canvas
    public void drawText(CharSequence text, int start, int end, float x5, float y5, Paint paint) {
        Canvas canvas = this.nativeCanvas;
        if (canvas == null) {
            Intrinsics.throwUninitializedPropertyAccessException("nativeCanvas");
            canvas = null;
    ...
    @Override // android.graphics.Canvas
    public void drawTextRun(CharSequence text, int start, int end, int contextStart, int contextEnd, float x5, float y5, boolean isRtl, Paint paint) {
        CanvasCompatM canvasCompatM = CanvasCompatM.INSTANCE;
        Canvas canvas = this.nativeCanvas;
        if (canvas == null) {
            Intrinsics.throwUninitializedPropertyAccessException("nativeCanvas");
        ...
        canvasCompatM.drawTextRun(canvas, text, start, end, contextStart, contextEnd, x5, y5, isRtl, paint);
    }
    ...
    @Override // android.graphics.Canvas
    @Deprecated
    public void drawBitmap(int[] colors, int offset, int stride, int x5, int y5, int width, int height, boolean hasAlpha, Paint paint) {
        Canvas canvas = this.nativeCanvas;
        if (canvas == null) {
            Intrinsics.throwUninitializedPropertyAccessException("nativeCanvas");
            canvas = null;
    ...
    @Override // android.graphics.Canvas
    public void drawTextRun(MeasuredText text, int start, int end, int contextStart, int contextEnd, float x5, float y5, boolean isRtl, Paint paint) {
        CanvasCompatQ canvasCompatQ = CanvasCompatQ.INSTANCE;
        Canvas canvas = this.nativeCanvas;
        if (canvas == null) {
            Intrinsics.throwUninitializedPropertyAccessException("nativeCanvas");
        ...
        canvasCompatQ.drawTextRun(canvas, text, start, end, contextStart, contextEnd, x5, y5, isRtl, paint);
    }
}
