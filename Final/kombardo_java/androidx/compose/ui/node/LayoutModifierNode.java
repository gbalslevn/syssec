...
public interface LayoutModifierNode extends DelegatableNode {
    default int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i5) {
        return NodeMeasuringIntrinsics.INSTANCE.maxHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.node.LayoutModifierNode$maxIntrinsicHeight$1
            ...
            public final MeasureResult mo1997measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j5) {
                return LayoutModifierNode.this.mo46measure3p2s80s(measureScope, measurable, j5);
            }
    ...
    /* renamed from: measure-3p2s80s */
    MeasureResult mo46measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j5);
