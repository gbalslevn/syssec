...
public final class LookaheadAlignmentLines extends AlignmentLines {
    ...
    protected long mo1984calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j5) {
        LookaheadDelegate lookaheadDelegate = nodeCoordinator.getLookaheadDelegate();
        Intrinsics.checkNotNull(lookaheadDelegate);
        long position = lookaheadDelegate.getPosition();
        return Offset.m1342plusMKHz9U(OffsetKt.Offset(IntOffset.m2640getXimpl(position), IntOffset.m2641getYimpl(position)), j5);
    }
