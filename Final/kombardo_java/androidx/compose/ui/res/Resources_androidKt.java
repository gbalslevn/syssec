...
public abstract class Resources_androidKt {
    public static final Resources resources(Composer composer, int i5) {
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1554054999, i5, -1, "androidx.compose.ui.res.resources (Resources.android.kt:33)");
        }
