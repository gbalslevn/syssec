...
public class ReflectionFactoryImpl extends ReflectionFactory {
    ...
    public KType typeOf(KClassifier kClassifier, List<KTypeProjection> list, boolean z5) {
        return kClassifier instanceof ClassBasedDeclarationContainer ? CachesKt.getOrCreateKType(((ClassBasedDeclarationContainer) kClassifier).getJClass(), list, z5) : KClassifiers.createType(kClassifier, list, z5, Collections.emptyList());
    }
