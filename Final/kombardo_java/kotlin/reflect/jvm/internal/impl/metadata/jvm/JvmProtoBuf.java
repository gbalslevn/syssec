            ...
            public Builder mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
                ...
                try {
                    try {
                        ...
                        JvmFieldSignature jvmFieldSignature2 = (JvmFieldSignature) e5.getUnfinishedMessage();
                        try {
                            throw e5;
                        } catch (Throwable th) {
                            th = th;
            ...
            public Builder mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
                ...
                try {
                    try {
                        ...
                        JvmMethodSignature jvmMethodSignature2 = (JvmMethodSignature) e5.getUnfinishedMessage();
                        try {
                            throw e5;
                        } catch (Throwable th) {
                            th = th;
            ...
            public Builder mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
                ...
                try {
                    try {
                        ...
                        JvmPropertySignature jvmPropertySignature2 = (JvmPropertySignature) e5.getUnfinishedMessage();
                        try {
                            throw e5;
                        } catch (Throwable th) {
                            th = th;
    ...
    public static final class StringTableTypes extends GeneratedMessageLite implements MessageLiteOrBuilder {
            ...
            public Builder mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
                ...
                try {
                    try {
                        ...
                        StringTableTypes stringTableTypes2 = (StringTableTypes) e5.getUnfinishedMessage();
                        try {
                            throw e5;
                        } catch (Throwable th) {
                            th = th;
        ...
        public static final class Record extends GeneratedMessageLite implements MessageLiteOrBuilder {
            ...
            public static final class Builder extends GeneratedMessageLite.Builder<Record, Builder> implements MessageLiteOrBuilder {
                ...
                public Builder setPredefinedIndex(int i5) {
                    this.bitField0_ |= 2;
                    this.predefinedIndex_ = i5;
                    return this;
                }

                public Builder setRange(int i5) {
                    this.bitField0_ |= 1;
                    this.range_ = i5;
                    return this;
                }
                ...
                public Builder mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
                    ...
                    try {
                        try {
                            ...
                            Record record2 = (Record) e5.getUnfinishedMessage();
                            try {
                                throw e5;
                            } catch (Throwable th) {
                                th = th;
            ...
            public int getSerializedSize() {
                ...
                for (int i7 = 0; i7 < this.substringIndex_.size(); i7++) {
                    i6 += CodedOutputStream.computeInt32SizeNoTag(this.substringIndex_.get(i7).intValue());
                }
                ...
                for (int i10 = 0; i10 < this.replaceChar_.size(); i10++) {
                    i9 += CodedOutputStream.computeInt32SizeNoTag(this.replaceChar_.get(i10).intValue());
                }
                int i11 = i8 + i9;
                ...
                if ((this.bitField0_ & 4) == 4) {
                    i11 += CodedOutputStream.computeBytesSize(6, getStringBytes());
                }
            ...
            public void writeTo(CodedOutputStream codedOutputStream) {
                ...
                for (int i5 = 0; i5 < this.substringIndex_.size(); i5++) {
                    codedOutputStream.writeInt32NoTag(this.substringIndex_.get(i5).intValue());
                }
                ...
                for (int i6 = 0; i6 < this.replaceChar_.size(); i6++) {
                    codedOutputStream.writeInt32NoTag(this.replaceChar_.get(i6).intValue());
                }
                if ((this.bitField0_ & 4) == 4) {
                        ...
                        try {
                            ...
                            if (readTag != 0) {
                                if (readTag == 8) {
                                    ...
                                    if ((i5 & 16) != 16 && codedInputStream.getBytesUntilLimit() > 0) {
                                        this.substringIndex_ = new ArrayList();
                                        i5 |= 16;
                                    }
        ...
        public int getSerializedSize() {
            ...
            for (int i7 = 0; i7 < this.record_.size(); i7++) {
                i6 += CodedOutputStream.computeMessageSize(1, this.record_.get(i7));
            }
            int i8 = 0;
            for (int i9 = 0; i9 < this.localName_.size(); i9++) {
                i8 += CodedOutputStream.computeInt32SizeNoTag(this.localName_.get(i9).intValue());
            }
            int i10 = i6 + i8;
        ...
        public void writeTo(CodedOutputStream codedOutputStream) {
            ...
            for (int i5 = 0; i5 < this.record_.size(); i5++) {
                codedOutputStream.writeMessage(1, this.record_.get(i5));
            }
            ...
            for (int i6 = 0; i6 < this.localName_.size(); i6++) {
                codedOutputStream.writeInt32NoTag(this.localName_.get(i6).intValue());
            }
            codedOutputStream.writeRawBytes(this.unknownFields);
        }
                    ...
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 10) {
                                ...
                                int pushLimit = codedInputStream.pushLimit(codedInputStream.readRawVarint32());
                                if ((i5 & 2) != 2 && codedInputStream.getBytesUntilLimit() > 0) {
                                    this.localName_ = new ArrayList();
                                    i5 |= 2;
                                }
                                while (codedInputStream.getBytesUntilLimit() > 0) {
