...
public interface TypeSystemContext extends TypeSystemOptimizationContext {
    ...
    TypeArgumentMarker get(TypeArgumentListMarker typeArgumentListMarker, int i5);

    TypeArgumentMarker getArgument(KotlinTypeMarker kotlinTypeMarker, int i5);

    TypeArgumentMarker getArgumentOrNull(RigidTypeMarker rigidTypeMarker, int i5);

    List<TypeArgumentMarker> getArguments(KotlinTypeMarker kotlinTypeMarker);

    TypeParameterMarker getParameter(TypeConstructorMarker typeConstructorMarker, int i5);
    ...
    KotlinTypeMarker makeDefinitelyNotNullOrNotNull(KotlinTypeMarker kotlinTypeMarker, boolean z5);
    ...
    KotlinTypeMarker withNullability(KotlinTypeMarker kotlinTypeMarker, boolean z5);

    RigidTypeMarker withNullability(RigidTypeMarker rigidTypeMarker, boolean z5);
}
