...
public abstract class KotlinTypePreparator extends AbstractTypePreparator {
    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (!(constructor instanceof CapturedTypeConstructorImpl)) {
            ...
            Collection<KotlinType> mo3719getSupertypes = intersectionTypeConstructor2.mo3719getSupertypes();
        ...
        if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
            ...
            Collection<KotlinType> mo3719getSupertypes2 = capturedTypeConstructorImpl.mo3719getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo3719getSupertypes2, 10));
            Iterator<T> it2 = mo3719getSupertypes2.iterator();
            while (it2.hasNext()) {
