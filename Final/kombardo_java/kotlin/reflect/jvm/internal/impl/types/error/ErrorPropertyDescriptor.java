...
public final class ErrorPropertyDescriptor implements PropertyDescriptor {
    ...
    public <R, D> R accept(DeclarationDescriptorVisitor<R, D> declarationDescriptorVisitor, D d5) {
        return (R) this.$$delegate_0.accept(declarationDescriptorVisitor, d5);
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.CallableMemberDescriptor
    public CallableMemberDescriptor copy(DeclarationDescriptor declarationDescriptor, Modality modality, DescriptorVisibility descriptorVisibility, CallableMemberDescriptor.Kind kind, boolean z5) {
        PropertyDescriptor copy = this.$$delegate_0.copy(declarationDescriptor, modality, descriptorVisibility, kind, z5);
    ...
    public ConstantValue<?> mo3686getCompileTimeInitializer() {
        return this.$$delegate_0.mo3686getCompileTimeInitializer();
    }
