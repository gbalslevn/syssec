...
public final class AbbreviatedType extends DelegatingSimpleType {
    ...
    @Override // kotlin.reflect.jvm.internal.impl.types.UnwrappedType
    public AbbreviatedType makeNullableAsSpecified(boolean z5) {
        return new AbbreviatedType(getDelegate().makeNullableAsSpecified(z5), this.abbreviation.makeNullableAsSpecified(z5));
    }
