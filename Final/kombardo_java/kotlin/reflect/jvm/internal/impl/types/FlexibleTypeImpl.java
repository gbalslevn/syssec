...
public final class FlexibleTypeImpl extends FlexibleType implements CustomTypeParameter {
    ...
    public boolean isTypeParameter() {
        return (getLowerBound().getConstructor().mo3718getDeclarationDescriptor() instanceof TypeParameterDescriptor) && Intrinsics.areEqual(getLowerBound().getConstructor(), getUpperBound().getConstructor());
    }

    @Override // kotlin.reflect.jvm.internal.impl.types.UnwrappedType
    public UnwrappedType makeNullableAsSpecified(boolean z5) {
        return KotlinTypeFactory.flexibleType(getLowerBound().makeNullableAsSpecified(z5), getUpperBound().makeNullableAsSpecified(z5));
    }
