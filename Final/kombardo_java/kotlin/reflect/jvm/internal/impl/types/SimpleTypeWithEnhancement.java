...
public final class SimpleTypeWithEnhancement extends DelegatingSimpleType implements TypeWithEnhancement {
    ...
    public SimpleType makeNullableAsSpecified(boolean z5) {
        UnwrappedType wrapEnhancement = TypeWithEnhancementKt.wrapEnhancement(getOrigin().makeNullableAsSpecified(z5), getEnhancement().unwrap().makeNullableAsSpecified(z5));
