...
public class JavaMethodDescriptor extends SimpleFunctionDescriptorImpl implements JavaCallableMemberDescriptor {
    ...
    public enum ParameterNamesStatus {
        ...
        public static ParameterNamesStatus get(boolean z5, boolean z6) {
    ...
    protected JavaMethodDescriptor(DeclarationDescriptor declarationDescriptor, SimpleFunctionDescriptor simpleFunctionDescriptor, Annotations annotations, Name name, CallableMemberDescriptor.Kind kind, SourceElement sourceElement, boolean z5) {
        ...
        this.isForRecordComponent = z5;
    }

    public static JavaMethodDescriptor createJavaMethod(DeclarationDescriptor declarationDescriptor, Annotations annotations, Name name, SourceElement sourceElement, boolean z5) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(5);
        }
        if (annotations == null) {
    ...
    public void setParameterNamesStatus(boolean z5, boolean z6) {
        this.parameterNamesStatus = ParameterNamesStatus.get(z5, z6);
    }
