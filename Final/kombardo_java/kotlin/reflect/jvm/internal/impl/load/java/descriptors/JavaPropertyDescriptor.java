...
public class JavaPropertyDescriptor extends PropertyDescriptorImpl implements JavaCallableMemberDescriptor {
    ...
    public JavaPropertyDescriptor(DeclarationDescriptor declarationDescriptor, Annotations annotations, Modality modality, DescriptorVisibility descriptorVisibility, boolean z5, Name name, SourceElement sourceElement, PropertyDescriptor propertyDescriptor, CallableMemberDescriptor.Kind kind, boolean z6, Pair<CallableDescriptor.UserDataKey<?>, ?> pair) {
        super(declarationDescriptor, propertyDescriptor, annotations, modality, descriptorVisibility, z5, name, kind, sourceElement, false, false, false, false, false, false);
        ...
        this.inType = null;
        this.isStaticFinal = z6;
        this.singleUserData = pair;
    }

    public static JavaPropertyDescriptor create(DeclarationDescriptor declarationDescriptor, Annotations annotations, Modality modality, DescriptorVisibility descriptorVisibility, boolean z5, Name name, SourceElement sourceElement, boolean z6) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(7);
        }
        if (annotations == null) {
        ...
        return new JavaPropertyDescriptor(declarationDescriptor, annotations, modality, descriptorVisibility, z5, name, sourceElement, null, CallableMemberDescriptor.Kind.DECLARATION, z6, null);
    }
