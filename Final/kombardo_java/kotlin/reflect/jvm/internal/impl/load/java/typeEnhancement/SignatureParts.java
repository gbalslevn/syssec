...
public final class SignatureParts extends AbstractSignatureParts<AnnotationDescriptor> {
    ...
    public /* synthetic */ SignatureParts(Annotated annotated, boolean z5, LazyJavaResolverContext lazyJavaResolverContext, AnnotationQualifierApplicabilityType annotationQualifierApplicabilityType, boolean z6, int i5, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public SignatureParts(Annotated annotated, boolean z5, LazyJavaResolverContext containerContext, AnnotationQualifierApplicabilityType containerApplicabilityType, boolean z6) {
