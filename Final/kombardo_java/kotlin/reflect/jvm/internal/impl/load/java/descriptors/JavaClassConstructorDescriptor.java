...
public class JavaClassConstructorDescriptor extends ClassConstructorDescriptorImpl implements JavaCallableMemberDescriptor {
    ...
    protected JavaClassConstructorDescriptor(ClassDescriptor classDescriptor, JavaClassConstructorDescriptor javaClassConstructorDescriptor, Annotations annotations, boolean z5, CallableMemberDescriptor.Kind kind, SourceElement sourceElement) {
        super(classDescriptor, javaClassConstructorDescriptor, annotations, z5, kind, sourceElement);
    ...
    public static JavaClassConstructorDescriptor createJavaConstructor(ClassDescriptor classDescriptor, Annotations annotations, boolean z5, SourceElement sourceElement) {
        if (classDescriptor == null) {
            $$$reportNull$$$0(4);
        }
        if (annotations == null) {
        ...
        return new JavaClassConstructorDescriptor(classDescriptor, null, annotations, z5, CallableMemberDescriptor.Kind.DECLARATION, sourceElement);
    }
    ...
    public void setHasStableParameterNames(boolean z5) {
        this.hasStableParameterNames = Boolean.valueOf(z5);
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.impl.FunctionDescriptorImpl
    public void setHasSynthesizedParameterNames(boolean z5) {
        this.hasSynthesizedParameterNames = Boolean.valueOf(z5);
    }
