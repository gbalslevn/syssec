...
public interface SignaturePropagator {
    ...
    public static class PropagatedSignature {
        ...
        public PropagatedSignature(KotlinType kotlinType, KotlinType kotlinType2, List<ValueParameterDescriptor> list, List<TypeParameterDescriptor> list2, List<String> list3, boolean z5) {
            if (kotlinType == null) {
                $$$reportNull$$$0(0);
            }
            if (list == null) {
