...
public final class FunctionClassDescriptor extends AbstractClassDescriptor {
    ...
    public FunctionClassDescriptor(StorageManager storageManager, PackageFragmentDescriptor containingDeclaration, FunctionTypeKind functionTypeKind, int i5) {
    ...
    private final class FunctionTypeConstructor extends AbstractClassTypeConstructor {
        ...
        public String toString() {
            return mo3718getDeclarationDescriptor().toString();
        }
        ...
        public FunctionClassDescriptor mo3718getDeclarationDescriptor() {
    ...
    public /* bridge */ /* synthetic */ ClassDescriptor mo3683getCompanionObjectDescriptor() {
    ...
    public /* bridge */ /* synthetic */ ClassConstructorDescriptor mo3684getUnsubstitutedPrimaryConstructor() {
