...
public final class UnsignedTypes {
    ...
    public static final boolean isUnsignedType(KotlinType type) {
        ...
        if (TypeUtils.noExpectedType(type) || (mo3718getDeclarationDescriptor = type.getConstructor().mo3718getDeclarationDescriptor()) == null) {
            return false;
        }
        return INSTANCE.isUnsignedClass(mo3718getDeclarationDescriptor);
    }
