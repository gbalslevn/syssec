...
public final class CharValue extends IntegerValueConstant<Character> {
    public CharValue(char c5) {
        super(Character.valueOf(c5));
    }

    private final String getPrintablePart(char c5) {
        switch (c5) {
            case '\b':
                return "\\b";
            case '\t':
            ...
            case 11:
            default:
                return isPrintableUnicode(c5) ? String.valueOf(c5) : "?";
            case '\f':
                return "\\f";
            case '\r':
                return "\\r";
    ...
    private final boolean isPrintableUnicode(char c5) {
