...
public abstract class DescriptorUtils {
    ...
    private static <D extends CallableDescriptor> void collectAllOverriddenDescriptors(D d5, Set<D> set) {
        if (d5 == null) {
            $$$reportNull$$$0(73);
        }
        if (set == 0) {
        ...
        Iterator<? extends CallableDescriptor> it = d5.getOriginal().getOverriddenDescriptors().iterator();
        while (it.hasNext()) {
    ...
    public static <D extends CallableDescriptor> Set<D> getAllOverriddenDescriptors(D d5) {
        if (d5 == null) {
            $$$reportNull$$$0(71);
        }
        LinkedHashSet linkedHashSet = new LinkedHashSet();
        collectAllOverriddenDescriptors(d5.getOriginal(), linkedHashSet);
    ...
    public static ClassDescriptor getClassDescriptorForTypeConstructor(TypeConstructor typeConstructor) {
        ...
        ClassDescriptor classDescriptor = (ClassDescriptor) typeConstructor.mo3718getDeclarationDescriptor();
    ...
    public static ModuleDescriptor getContainingModuleOrNull(KotlinType kotlinType) {
        ...
        return getContainingModuleOrNull(mo3718getDeclarationDescriptor);
    }
    ...
    public static DescriptorVisibility getDefaultConstructorVisibility(ClassDescriptor classDescriptor, boolean z5) {
        if (classDescriptor == null) {
            $$$reportNull$$$0(48);
        }
    ...
    public static ClassDescriptor getSuperClassDescriptor(ClassDescriptor classDescriptor) {
        ...
        Iterator<KotlinType> it = classDescriptor.getTypeConstructor().mo3719getSupertypes().iterator();
        while (it.hasNext()) {
    ...
    private static boolean isSameClass(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        ...
        DeclarationDescriptor original = mo3718getDeclarationDescriptor.getOriginal();
    ...
    public static boolean isSubtypeOfClass(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        ...
        Iterator<KotlinType> it = kotlinType.getConstructor().mo3719getSupertypes().iterator();
        while (it.hasNext()) {
    ...
    public static <D extends CallableMemberDescriptor> D unwrapFakeOverride(D d5) {
        if (d5 == null) {
            $$$reportNull$$$0(59);
        }
        while (d5.getKind() == CallableMemberDescriptor.Kind.FAKE_OVERRIDE) {
            Collection<? extends CallableMemberDescriptor> overriddenDescriptors = d5.getOverriddenDescriptors();
            if (overriddenDescriptors.isEmpty()) {
                throw new IllegalStateException("Fake override should have at least one overridden descriptor: " + d5);
            }
            d5 = (D) overriddenDescriptors.iterator().next();
        }
        return d5;
    }

    public static <D extends DeclarationDescriptorWithVisibility> D unwrapFakeOverrideToAnyDeclaration(D d5) {
        if (d5 == null) {
            $$$reportNull$$$0(64);
        }
        if (d5 instanceof CallableMemberDescriptor) {
            return unwrapFakeOverride((CallableMemberDescriptor) d5);
        }
        if (d5 == null) {
            $$$reportNull$$$0(65);
        }
    ...
    public static <D extends DeclarationDescriptor> D getParentOfType(DeclarationDescriptor declarationDescriptor, Class<D> cls, boolean z5) {
        if (cls == null) {
            $$$reportNull$$$0(19);
        }
        if (declarationDescriptor == null) {
