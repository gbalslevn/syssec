...
public class MutableClassDescriptor extends ClassDescriptorBase {
    ...
    public MutableClassDescriptor(DeclarationDescriptor declarationDescriptor, ClassKind classKind, boolean z5, boolean z6, Name name, SourceElement sourceElement, StorageManager storageManager) {
