...
public class TypeParameterDescriptorImpl extends AbstractTypeParameterDescriptor {
    ...
    private TypeParameterDescriptorImpl(DeclarationDescriptor declarationDescriptor, Annotations annotations, boolean z5, Variance variance, Name name, int i5, SourceElement sourceElement, Function1<KotlinType, Void> function1, SupertypeLoopChecker supertypeLoopChecker, StorageManager storageManager) {
    ...
    public static TypeParameterDescriptorImpl createForFurtherModification(DeclarationDescriptor declarationDescriptor, Annotations annotations, boolean z5, Variance variance, Name name, int i5, SourceElement sourceElement, StorageManager storageManager) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(6);
        }
        if (annotations == null) {
        ...
        return createForFurtherModification(declarationDescriptor, annotations, z5, variance, name, i5, sourceElement, null, SupertypeLoopChecker.EMPTY.INSTANCE, storageManager);
    }

    public static TypeParameterDescriptor createWithDefaultBound(DeclarationDescriptor declarationDescriptor, Annotations annotations, boolean z5, Variance variance, Name name, int i5, StorageManager storageManager) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(0);
        }
        if (annotations == null) {
        ...
        TypeParameterDescriptorImpl createForFurtherModification = createForFurtherModification(declarationDescriptor, annotations, z5, variance, name, i5, SourceElement.NO_SOURCE, storageManager);
    ...
    protected void mo3721reportSupertypeLoopError(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(27);
        }
    ...
    public static TypeParameterDescriptorImpl createForFurtherModification(DeclarationDescriptor declarationDescriptor, Annotations annotations, boolean z5, Variance variance, Name name, int i5, SourceElement sourceElement, Function1<KotlinType, Void> function1, SupertypeLoopChecker supertypeLoopChecker, StorageManager storageManager) {
        ...
        return new TypeParameterDescriptorImpl(declarationDescriptor, annotations, z5, variance, name, i5, sourceElement, function1, supertypeLoopChecker, storageManager);
    }
}
