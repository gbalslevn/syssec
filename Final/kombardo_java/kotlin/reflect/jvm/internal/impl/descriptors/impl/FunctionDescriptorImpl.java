...
public abstract class FunctionDescriptorImpl extends DeclarationDescriptorNonRootImpl implements FunctionDescriptor {
    ...
    public class CopyConfiguration implements FunctionDescriptor.CopyBuilder<FunctionDescriptor> {
        ...
        @Override // kotlin.reflect.jvm.internal.impl.descriptors.FunctionDescriptor.CopyBuilder
        public <V> FunctionDescriptor.CopyBuilder<FunctionDescriptor> putUserData(CallableDescriptor.UserDataKey<V> userDataKey, V v5) {
            if (userDataKey == null) {
                $$$reportNull$$$0(39);
            }
            this.userDataMap.put(userDataKey, v5);
            return this;
        }

        public CopyConfiguration setHasSynthesizedParameterNames(boolean z5) {
            this.newHasSynthesizedParameterNames = Boolean.valueOf(z5);
            return this;
        }

        public CopyConfiguration setJustForTypeSubstitution(boolean z5) {
            this.justForTypeSubstitution = z5;
            return this;
        }
    ...
    private SourceElement getSourceToUseForCopy(boolean z5, FunctionDescriptor functionDescriptor) {
    ...
    private void setHiddenForResolutionEverywhereBesideSupercalls(boolean z5) {
        this.isHiddenForResolutionEverywhereBesideSupercalls = z5;
    }

    private void setHiddenToOvercomeSignatureClash(boolean z5) {
        this.isHiddenToOvercomeSignatureClash = z5;
    }
    ...
    public <R, D> R accept(DeclarationDescriptorVisitor<R, D> declarationDescriptorVisitor, D d5) {
        return declarationDescriptorVisitor.visitFunctionDescriptor(this, d5);
    }
    ...
    public FunctionDescriptor doSubstitute(CopyConfiguration copyConfiguration) {
        ...
        if (!copyConfiguration.newContextReceiverParameters.isEmpty()) {
            ...
            for (ReceiverParameterDescriptor receiverParameterDescriptor2 : copyConfiguration.newContextReceiverParameters) {
                ...
                int i6 = i5 + 1;
                arrayList2.add(DescriptorFactory.createContextReceiverParameterForCallable(createSubstitutedCopy, substitute2, ((ImplicitContextReceiver) receiverParameterDescriptor2.getValue()).getCustomLabelName(), receiverParameterDescriptor2.getAnnotations(), i5));
        ...
        boolean z5 = zArr[0] | (substitute != copyConfiguration.newReturnType);
        zArr[0] = z5;
        if (!z5 && copyConfiguration.justForTypeSubstitution) {
            return this;
        }
    ...
    public FunctionDescriptorImpl initialize(ReceiverParameterDescriptor receiverParameterDescriptor, ReceiverParameterDescriptor receiverParameterDescriptor2, List<ReceiverParameterDescriptor> list, List<? extends TypeParameterDescriptor> list2, List<ValueParameterDescriptor> list3, KotlinType kotlinType, Modality modality, DescriptorVisibility descriptorVisibility) {
        ...
        for (int i5 = 0; i5 < list2.size(); i5++) {
            TypeParameterDescriptor typeParameterDescriptor = list2.get(i5);
            if (typeParameterDescriptor.getIndex() != i5) {
                throw new IllegalStateException(typeParameterDescriptor + " index is " + typeParameterDescriptor.getIndex() + " but position is " + i5);
            }
        }
        for (int i6 = 0; i6 < list3.size(); i6++) {
            ValueParameterDescriptor valueParameterDescriptor = list3.get(i6);
            if (valueParameterDescriptor.getIndex() != i6) {
                throw new IllegalStateException(valueParameterDescriptor + "index is " + valueParameterDescriptor.getIndex() + " but position is " + i6);
            }
        }
        return this;
    }
    ...
    public void setHasSynthesizedParameterNames(boolean z5) {
        this.hasSynthesizedParameterNames = z5;
    }
    ...
    public static List<ValueParameterDescriptor> getSubstitutedValueParameters(FunctionDescriptor functionDescriptor, List<ValueParameterDescriptor> list, TypeSubstitutor typeSubstitutor, boolean z5, boolean z6, boolean[] zArr) {
