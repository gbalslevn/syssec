...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    ...
    public class TypeParameterTypeConstructor extends AbstractTypeConstructor {
        ...
        protected void reportSupertypeLoopError(KotlinType kotlinType) {
            ...
            this.this$0.mo3721reportSupertypeLoopError(kotlinType);
        }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AbstractTypeParameterDescriptor(final StorageManager storageManager, DeclarationDescriptor declarationDescriptor, Annotations annotations, final Name name, Variance variance, boolean z5, int i5, SourceElement sourceElement, final SupertypeLoopChecker supertypeLoopChecker) {
    ...
    public <R, D> R accept(DeclarationDescriptorVisitor<R, D> declarationDescriptorVisitor, D d5) {
        return declarationDescriptorVisitor.visitTypeParameterDescriptor(this, d5);
    }
    ...
    public List<KotlinType> getUpperBounds() {
        List<KotlinType> mo3719getSupertypes = ((TypeParameterTypeConstructor) getTypeConstructor()).mo3719getSupertypes();
        if (mo3719getSupertypes == null) {
            $$$reportNull$$$0(8);
        }
    ...
    protected abstract void mo3721reportSupertypeLoopError(KotlinType kotlinType);
