...
public abstract class WireFormat {
    ...
    public static class FieldType {
        ...
        static {
            ...
            GROUP = fieldType10;
            int i5 = 2;
            FieldType fieldType11 = new FieldType("MESSAGE", 10, javaType3, i5) { // from class: kotlin.reflect.jvm.internal.impl.protobuf.WireFormat.FieldType.3
                @Override // kotlin.reflect.jvm.internal.impl.protobuf.WireFormat.FieldType
                public boolean isPackable() {
                    return false;
                }
            ...
            MESSAGE = fieldType11;
            FieldType fieldType12 = new FieldType("BYTES", 11, JavaType.BYTE_STRING, i5) { // from class: kotlin.reflect.jvm.internal.impl.protobuf.WireFormat.FieldType.4
                @Override // kotlin.reflect.jvm.internal.impl.protobuf.WireFormat.FieldType
                public boolean isPackable() {
                    return false;
                }
        ...
        private FieldType(String str, int i5, JavaType javaType, int i6) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int makeTag(int i5, int i6) {
        return (i5 << 3) | i6;
    }
}
