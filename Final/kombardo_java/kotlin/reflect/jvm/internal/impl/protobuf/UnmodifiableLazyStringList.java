...
public class UnmodifiableLazyStringList extends AbstractList<String> implements RandomAccess, LazyStringList {
    ...
    public ListIterator<String> listIterator(int i5) {
        return new ListIterator<String>(i5) { // from class: kotlin.reflect.jvm.internal.impl.protobuf.UnmodifiableLazyStringList.1
            ListIterator<String> iter;
            final /* synthetic */ int val$index;

            {
                this.val$index = i5;
                this.iter = UnmodifiableLazyStringList.this.list.listIterator(i5);
            }
